package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_820:uint = 4;
      ...
      protected var var_409:uint = 0;
      
      protected var _context:IContext = null;
      
      protected var var_2153:Boolean = false;
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_409 + "]";
      }
   }
}
