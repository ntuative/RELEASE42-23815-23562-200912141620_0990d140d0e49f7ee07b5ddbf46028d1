   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected final function announceInterfaceAvailability(param1:IID, param2:Component) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               error("Interface " + param1 + " still unavailabe!",true,CoreComponent.const_1335);
            }
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         removeLibraryLoader(_loc2_);
         error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,CoreComponent.const_1157);
      }
         ...
         while(_loc18_ < _loc5_.length())
         {
            ...
            if(_loc24_ > 0)
            {
               ...
               while(_loc26_ < _loc24_)
               {
                  ...
                  {
                     error("Manifest for component " + _loc7_ + " contains broken asset \"" + _loc21_ + "\"!",true,CoreComponent.const_525);
                  }
                  _loc26_++;
               }
            }
            ...
            if(_loc6_ == null)
            {
               error("Invalid component class " + _loc7_ + "!",true,CoreComponent.const_525);
               return false;
            }
            ...
            if(_loc4_ != null)
            {
               if(_loc25_ != null)
               {
                  ...
                  {
                     _loc25_.dispose();
                     error("Component \"" + _loc7_ + "\" did not save provided asset library!",true,CoreComponent.const_525);
                  }
               }
