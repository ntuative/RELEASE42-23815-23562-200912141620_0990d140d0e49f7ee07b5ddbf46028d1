package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1083:uint = 8;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_2057 = new Dictionary();
         TypeCodeTable.fillTables(var_1477,var_2057);
         var_1262 = new Dictionary();
         var_2056 = new Dictionary();
         StateCodeTable.fillTables(var_1262,var_2056);
         ...
         if(var_359 == null)
         {
            ...
            var_359.push(WindowState.const_67);
            var_359.push(WindowState.const_84);
            var_359.push(WindowState.const_48);
            var_359.push(WindowState.const_72);
            var_359.push(WindowState.const_68);
            var_359.push(WindowState.const_89);
            var_359.push(WindowState.const_76);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1262)
         {
            _loc3_.push(var_1262[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1477[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_565[param1] = new Array(SkinContainer.const_1083);
         }
