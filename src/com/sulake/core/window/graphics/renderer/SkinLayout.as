package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinLayout extends ChildEntityArray implements ISkinLayout
   {
      ...
      protected var var_2175:Boolean;
      
      protected var _height:uint;
      
      protected var _name:String;
      
      protected var var_865:IChildEntityArray;
      ...
      public function getDefaultRegion(param1:String, param2:Rectangle) : void
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = var_865.getChildByName(param1) as ISkinLayoutEntity;
            if(_loc3_ == null)
            {
      ...
      public function isFixedHeight() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(ISkinLayoutEntity(getChildAt(_loc2_)).scaleV != SkinLayoutEntity.const_412)
            {
               return false;
            }
            _loc2_++;
      ...
      public function dispose() : void
      {
         ...
         for(_loc3_ in var_865)
         {
            ISkinLayoutEntity(var_865[_loc3_]).dispose();
            delete var_865[_loc3_];
         }
      }
      ...
      public function isFixedWidth() : Boolean
      {
         ...
         while(_loc2_ < _loc1_)
         {
            if(ISkinLayoutEntity(getChildAt(_loc2_)).scaleH != SkinLayoutEntity.const_412)
            {
               return false;
            }
            _loc2_++;
