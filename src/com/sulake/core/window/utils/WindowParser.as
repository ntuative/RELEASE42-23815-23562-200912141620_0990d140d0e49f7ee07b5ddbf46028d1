package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1426:String = "_INCLUDE";
      
      public static const ELEMENT_TAG_EXCLUDE:String = "_EXCLUDE";
      
      public static const const_1425:String = "_TEMP";
      ...
      protected var var_1304:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         ParamCodeTable.fillTables(var_876,var_1304);
         var_1305 = new Map();
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            for(_loc1_ in var_876)
            {
               delete var_876[_loc1_];
            }
            for(_loc1_ in var_1304)
            {
               delete var_1304[_loc1_];
            }
            var_1305.dispose();
            var_1305 = null;
            _context = null;
