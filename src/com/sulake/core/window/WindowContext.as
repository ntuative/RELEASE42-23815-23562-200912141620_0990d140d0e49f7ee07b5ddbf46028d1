package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, ICoreUpdateReceiver
   {
      ...
      private static var var_882:Factory;
      
      private static var var_131:IWindowRenderer;
      ...
      protected var var_2166:IWindowFactory;
      
      private var _disposed:Boolean = false;
      
      private var var_588:WindowController;
      
      private var var_603:Date;
      
      protected var var_2167:IWindowParser;
      
      protected var var_864:Error;
      
      protected var var_2165:IInternalWindowServices;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         var_305 = param5;
         var_2165 = new InternalWindowServices(this,param5);
         var_2166 = param3;
         var_2167 = new WindowParser(this);
         var_603 = new Date();
         if(var_882 == null)
         {
            var_882 = new Factory();
         ...
         var_93 = new DesktopController("_CONTEXT_DESKTOP_" + _name,"Desktop " + _name,WindowType.const_381,WindowStyle.const_269,WindowParam.const_95,this,param6,null,null);
         var_305.addChild(var_93.getDisplayObject());
      ...
      public function destroy(param1:IWindow) : Boolean
      {
         ...
         if(param1.state != WindowState.const_345)
         {
            param1.destroy();
         }
         var_131.removeRenderable(param1 as WindowController);
         return true;
      }
      
      public function create(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:Rectangle, param7:Function, param8:IWindow, param9:uint, param10:Array = null, param11:Array = null) : IWindow
      {
         var _loc12_:Class = var_882.getWindowClassByType(param3);
         if(_loc12_ == null)
         {
            handleError(WindowContext.const_1303,new Error("Failed to solve implementation for window \"" + param1 + "\"!"));
            return null;
         }
         if(param8 == null)
         {
      ...
      public function dispose() : void
      {
         ...
         var_305.removeChild(IGraphicContextHost(var_93).getGraphicContext(true) as DisplayObject);
         var_93.destroy();
         var_93 = null;
         var_1038.destroy();
         var_1038 = null;
      ...
      private function stageResizedHandler(param1:Event) : void
      {
         if(var_93 != null && true)
         {
            if(var_305 is Stage)
            {
               var_93.width = Stage(var_305).stageWidth;
               var_93.height = Stage(var_305).stageHeight;
            }
            else
            {
               var_93.width = var_305.width;
               var_93.height = var_305.height;
            }
         }
      }
      ...
      {
         var_131.addToRenderQueue(WindowController(param1),param2,param3);
         return true;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent) : WindowController
      {
         ...
         var _loc4_:BitmapData = var_131.getDrawBufferForRenderable(param1);
