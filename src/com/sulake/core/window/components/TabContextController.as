package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1018:String = "content";
      
      private static const const_1017:String = "selector";
       
      
      private var var_1159:Boolean = false;
      
      protected var var_870:ITabSelectorWindow;
      
      private var _initialized:Boolean = false;
      
      protected var var_1521:IWindowContainer;
      ...
      public function get container() : IWindowContainer
      {
         if(var_1521 == null)
         {
            var_1521 = findChildByTag(TabContextController.const_1018) as IWindowContainer;
         }
         return var_1521;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_870 == null)
         {
            var_870 = findChildByTag(TabContextController.const_1017) as ITabSelectorWindow;
            if(var_870 != null)
            {
               var_870.procedure = selectorEventProc;
            }
         }
         return var_870;
      }
