package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_333:IScrollbarWindow;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_333)
         {
            var_333 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_333)
            {
               var_333.addEventListener(WindowEvent.const_261,scrollBarEventProc);
               var_333.addEventListener(WindowEvent.const_219,scrollBarEventProc);
            }
         }
         return var_333;
      }
      ...
      override public function dispose() : void
      {
         if(var_333)
         {
            var_333.removeEventListener(WindowEvent.const_261,scrollBarEventProc);
            var_333.removeEventListener(WindowEvent.const_219,scrollBarEventProc);
            var_333 = null;
         }
         if(_cachedItemList)
         {
