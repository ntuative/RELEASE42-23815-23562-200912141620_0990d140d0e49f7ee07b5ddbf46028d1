package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      public function InteractiveController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         param5 |= 0;
         var_417 = new Array();
         var_417[0] = MouseCursorType.const_284;
         var_417[1] = MouseCursorType.const_39;
         var_417[2] = MouseCursorType.const_284;
         var_417[3] = MouseCursorType.const_284;
         var_417[4] = MouseCursorType.const_39;
         var_417[5] = MouseCursorType.const_39;
         var_417[6] = MouseCursorType.const_284;
         if(var_311 == null)
         {
            var_311 = new Array();
            var_311[0] = WindowState.const_89;
            var_311[1] = WindowState.const_68;
            var_311[2] = WindowState.const_72;
            var_311[3] = WindowState.const_58;
            var_311[4] = WindowState.const_48;
            var_311[5] = WindowState.const_84;
            var_311[6] = WindowState.const_67;
         }
