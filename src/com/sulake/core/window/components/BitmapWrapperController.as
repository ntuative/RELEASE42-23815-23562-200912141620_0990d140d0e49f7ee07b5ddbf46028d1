package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("handle_bitmap_disposing",var_420,PropertyStruct.const_57,var_420 != true));
         _loc1_.push(new PropertyStruct("bitmap_asset_name",var_1045,PropertyStruct.const_215,var_1045 != null));
         return _loc1_;
      }
