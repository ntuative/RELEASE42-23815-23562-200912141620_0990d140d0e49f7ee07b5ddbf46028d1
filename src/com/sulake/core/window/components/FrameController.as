package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1061:String = "_TITLE";
      
      private static const const_1060:String = "_CONTENT";
      
      private static const const_1062:String = "_HEADER";
      
      private static const const_1059:String = "_SCALER";
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1209 == null)
         {
            var_1209 = findChildByTag(const_1062) as IHeaderWindow;
            if(!var_1209)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1061) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1059) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1294 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_34 == null)
         {
            var_34 = findChildByTag(const_1060) as IWindowContainer;
            if(!var_34)
            {
