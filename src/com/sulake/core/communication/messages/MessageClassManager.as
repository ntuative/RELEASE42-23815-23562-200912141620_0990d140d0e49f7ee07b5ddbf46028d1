package com.sulake.core.communication.messages
{
   ...
   public class MessageClassManager implements IMessageClassManager
   {
      ...
      public function getMessageComposerID(param1:IMessageComposer) : int
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = -1;
         for(_loc3_ in var_736)
         {
            _loc4_ = var_736[_loc3_] as Class;
            if(param1 is _loc4_)
            {
      ...
      {
         var _loc2_:Array = var_598[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function toString() : String
      {
         ...
         for(_loc2_ in var_598)
         {
            _loc1_ += _loc2_ + " -> " + var_598[_loc2_] + "\n";
         }
         return _loc1_;
      }
      ...
      private function registerMessageEvent(param1:int, param2:Class) : Boolean
      {
         ...
         if(_loc3_..implementsInterface.@type == _messageEventInterface)
         {
            ...
            if(true)
            {
               var_598[param1] = [param2];
            }
            else
            {
               _loc6_ = var_598[param1];
               _loc6_.push(param2);
            }
            return true;
         }
