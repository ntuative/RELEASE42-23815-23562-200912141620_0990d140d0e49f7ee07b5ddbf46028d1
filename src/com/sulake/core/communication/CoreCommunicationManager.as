package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, ICoreUpdateReceiver
   {
      ...
      private var var_2008:IConnectionStateListener;
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         for(_loc4_ in var_391)
         {
            _loc10_;
            if(var_391[_loc4_] == param1)
            {
               _loc3_ = _loc4_;
               break;
            }
      ...
      {
         if(param1 == null || var_391 == null)
         {
            return null;
         }
         return var_391[param1] as IConnection;
      }
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in var_1227)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
      ...
      {
         var _loc2_:* = null;
         for each(var _loc5_ in var_391)
         {
            _loc2_ = _loc5_;
            _loc5_;
