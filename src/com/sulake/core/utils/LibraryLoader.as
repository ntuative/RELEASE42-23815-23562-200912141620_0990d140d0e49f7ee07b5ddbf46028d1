package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1356:uint = 2;
      
      protected static const const_1354:uint = 1;
      
      protected static const const_1357:int = 5;
      
      protected static const const_1026:uint = 7;
      
      protected static const const_1353:uint = 4;
      
      protected static const const_1355:uint = 3;
      ...
      protected var var_309:URLRequest;
      ...
      protected function prepareLibrary() : void
      {
         ...
         if(var_346 == null)
         {
            failure("Failed to find resource class \"" + _name + "\" in library " + var_309.url + "!");
            return;
         }
         try
         {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(var_418 == LibraryLoader.const_1355)
         {
            if(analyzeLibrary())
            {
               var_418 |= 0;
         ...
         if(var_418 == LibraryLoader.const_1026)
         {
            var_1294 = true;
            prepareLibrary();
            removeEventListeners();
      ...
      protected function handleHttpStatus(param1:int) : Boolean
      {
         if(param1 >= 400)
         {
            if(var_869 > 0)
            {
               var_1.close();
               var_1.unload();
               addRequestCounterToUrlRequest(var_309,const_1357 - var_869);
               var_1.load(var_309,_context);
               --var_869;
               return true;
            }
