package com.sulake.room.object.visualization.utils
{
   ...
   public class GraphicAssetCollection implements IGraphicAssetCollection
   {
      ...
      private var var_502:IAssetLibrary;
      ...
      public function define(param1:XML) : Boolean
      {
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(_loc4_.length() > 0)
            {
               ...
               _loc11_ = var_502.getAssetByName(_loc6_);
      ...
      public function addAsset(param1:String, param2:BitmapData, param3:Boolean) : Boolean
      {
         ...
         var _loc4_:BitmapDataAsset = var_502.getAssetByName(param1) as BitmapDataAsset;
         if(_loc4_ == null)
         {
            _loc4_ = new BitmapDataAsset(var_502.getAssetTypeDeclarationByClass(BitmapDataAsset));
            var_502.setAsset(param1,_loc4_);
