package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_713:RoomObjectLocationCache;
      ...
      private var var_208:BitmapDataCache;
      
      private var _geometry:RoomGeometry;
      
      private var var_1578:Number = -10000000;
      
      private var var_1579:Number = -10000000;
      ...
      private var var_890:IRoomRenderingCanvasMouseListener = null;
      
      private var var_891:Point;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_208 = new BitmapDataCache(1024 * 1024 * 16);
         var _loc6_:* = null;
         if(_container != null)
         {
            _loc6_ = "null";
         }
         var_713 = new RoomObjectLocationCache(_loc6_);
         var_279 = new Map();
      ...
      public function update() : void
      {
         if(var_892 == 0)
         {
            checkMouseHits(var_891.x,var_891.y,MouseEvent.MOUSE_MOVE);
         }
         var_892 = 0;
         ++var_1315;
      }
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_55.graphics.beginFill(var_19);
      ...
      {
         var _loc11_:Number = param1 - var_889 / 2;
         var _loc12_:Number = param2 - var_888 / 2;
         var _loc13_:* = null;
      ...
      public function render(param1:int) : void
      {
         ...
         if(_loc8_ < var_123.length)
         {
            var_123.splice(_loc8_);
         }
         _loc3_ = getTimer();
         ErrorReportStorage.addDebugData("Canvas rendering split time","Canvas render split: " + (_loc3_ - _loc2_));
         var _loc12_:String = " ";
         ...
         ErrorReportStorage.addDebugData("Canvas sprite count","Sorting sprites" + _loc12_ + var_123.length);
         var_123.sortOn("z",0 | 0);
         ErrorReportStorage.addDebugData("Canvas sprite count","Sorted sprites" + _loc12_ + var_123.length);
         var _loc13_:* = null;
         var _loc14_:int = 0;
         _loc7_ = 0;
         while(_loc7_ < _loc8_)
         {
            _loc13_ = var_123[_loc7_] as SortableSprite;
            updateSprite(_loc7_,_loc13_);
            _loc13_.bitmapData = null;
            _loc7_++;
         }
         cleanSprites(var_123.length);
         var_1577 = param1;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_427.length)
            {
               cleanSprite(var_427[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_427 = [];
         }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(_container == null || var_279 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = var_279.getKey(_loc1_);
            _loc3_ = var_279.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_890 != null)
                  {
                     var_890.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1315,geometry);
                  }
                  else
                  {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:uint, param3:String, param4:Boolean = false) : BitmapData
      {
         ...
         if(param3.length > 0)
         {
            _loc6_ = var_208.getBitmapData(_loc5_);
            if(!param4)
            {
               return _loc6_;
            }
         ...
         if(_loc6_ == null)
         {
            ...
            if(param3.length > 0)
            {
               var_208.addBitmapData(_loc5_,_loc6_);
            }
         }
         return _loc6_;
      }
      ...
      {
         if(param1 < 0 || param1 >= var_123.length)
         {
            return null;
         }
         return var_123[param1] as SortableSprite;
      }
      
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         if(var_279 != null && param1 != null)
         {
            var_279.add(param2,param1);
         }
      }
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_428.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_428.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_1578 || param2 != var_1579)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_428.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_428.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_427.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false) : BitmapData
      {
         ...
         if(param2.length > 0)
         {
            _loc5_ = var_208.getBitmapData(_loc4_);
            if(!param3)
            {
               return _loc5_;
            }
         ...
         if(_loc5_ == null)
         {
            ...
            if(param2.length > 0)
            {
               var_208.addBitmapData(_loc4_,_loc5_);
            }
         }
         return _loc5_;
      }
      ...
      private function getBitmapData(param1:BitmapData, param2:String, param3:Boolean, param4:uint) : BitmapData
      {
         ...
         if(param3 && param4 != 16777215)
         {
            ...
            if(param2.length > 0)
            {
               _loc5_ = var_208.getBitmapData(_loc6_);
            }
            if(_loc5_ == null)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  var_208.addBitmapData(_loc6_,_loc5_);
                  return _loc5_;
               }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int) : int
      {
         ...
         var _loc6_:IVector3d = var_713.getScreenLocation(param1,_geometry);
         if(_loc6_ == null)
         {
            return 0;
         }
         ...
         _loc7_ += int(var_889 / 2);
         _loc8_ += int(var_888 / 2);
         var _loc10_:int = 0;
         var _loc11_:* = null;
         var _loc12_:* = null;
         var _loc13_:int = 0;
            ...
            if(_loc12_ != null && _loc12_.visible)
            {
               ...
               if(_loc16_ != null)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     ...
                     if(_loc13_ + _loc18_.width >= 0 && _loc13_ < var_889 && (_loc14_ + _loc18_.height >= 0 && _loc14_ < var_888))
                     {
                        if(param3 + _loc10_ < var_123.length)
                        {
                           _loc11_ = var_123[param3 + _loc10_];
