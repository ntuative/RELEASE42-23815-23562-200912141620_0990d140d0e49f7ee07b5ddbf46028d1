package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_540,RoomWidgetStickieSendUpdateMessage.const_652,RoomWidgetStickieSendUpdateMessage.const_453];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_540:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     _loc11_ = new RoomWidgetStickieDataUpdateEvent(RoomWidgetStickieDataUpdateEvent.const_497,_loc2_.id,_loc3_.getType(),_loc9_,_loc8_,_loc10_);
                     _container.events.dispatchEvent(_loc11_);
                  }
               }
               break;
            case RoomWidgetStickieSendUpdateMessage.const_453:
               ...
               break;
            case RoomWidgetStickieSendUpdateMessage.const_652:
