package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               ...
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_104,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_130,onFigureUpdate);
         ...
         if(false)
         {
            ...
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_104,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_130,onFigureUpdate);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_499);
               _loc6_.id = param1.id;
               ...
               {
                  _loc20_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_289);
            ...
            case RoomObjectCategoryEnum.const_37:
               ...
               if(_loc9_.type == RoomObjectTypeEnum.const_312)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc9_.webID);
                  return null;
               }
               if(_loc9_.type == RoomObjectTypeEnum.const_407)
               {
                  _loc10_ = "null";
               ...
               {
                  if(_loc9_.type != RoomObjectTypeEnum.const_886)
                  {
                     return null;
                  }
                  _loc10_ = "null";
               ...
               if(_loc14_ != null)
               {
                  _loc11_.carryItem = _loc14_.getModel().getNumber(RoomObjectVariableEnum.const_536);
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_206)
               {
                  _loc11_.realName = _container.sessionDataManager.realName;
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_186)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     _loc28_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_512);
                  ...
                  _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1178;
                  if(!_loc23_)
                  {
                  ...
                  if(!_loc24_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_963;
                  }
                  if(!_loc25_)
                  {
               ...
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc12_.push(RoomWidgetUserInfoUpdateEvent.const_1292);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_537.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_50);
            var_537.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_512);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_319);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1111);
      ...
      public function dispose() : void
      {
         ...
         if(var_537 != null)
         {
            ...
            {
               _loc3_ = var_537.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_476)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_319:
            ...
            case RoomWidgetUserActionMessage.const_549:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_816,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_504:
               ...
               _container.method_2.reportUser(_loc2_,_loc3_.name);
               break;
