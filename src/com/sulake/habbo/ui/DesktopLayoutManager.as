package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1596:String = "room_desktop_layout_container";
      
      private const const_1052:String = "room_view";
      
      private var var_650:int = 50;
      
      private var var_2220:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_67.getChildByTag(const_1052) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_67.findChildByTag(const_1052) as IWindowContainer;
         if(_loc1_ != null)
         {
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_650;
               _loc2_.width = var_67.desktop.width - var_650;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_650;
               _loc2_.height = var_67.desktop.height - var_650;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_67.desktop.width;
