package com.sulake.habbo.ui
{
   ...
   public class RoomQueueWidgetHandler implements IRoomWidgetHandler
   {
            ...
            case RoomSessionQueueEvent.const_418:
               ...
               switch(_loc2_.queueSetTarget)
               {
                  case RoomSessionQueueEvent.const_971:
                     _loc3_ = "null";
                     break;
                  case RoomSessionQueueEvent.const_914:
                     _loc3_ = "null";
               }
               if(_loc3_ == null)
               {
               ...
               if(_loc5_.length > 1)
               {
                  if(_loc4_ && _loc2_.queueTypes.indexOf(RoomSessionQueueEvent.const_960) != -1)
                  {
                     _loc6_ = _loc2_.getQueueSize(RoomSessionQueueEvent.const_960) + 1;
                     _loc7_ = true;
                  }
                  else
                  {
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomQueueMessage.const_618);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomQueueMessage.CHANGE_TO_SPECTATOR_QUEUE:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_914);
               break;
            case RoomWidgetRoomQueueMessage.const_618:
               _container.roomSession.changeQueue(RoomSessionQueueEvent.const_971);
               break;
            case RoomWidgetRoomQueueMessage.const_675:
               if(false)
               {
                  _container.catalog.openCatalogPage(CatalogPageName.const_292,true);
               }
         }
         return null;
      }
