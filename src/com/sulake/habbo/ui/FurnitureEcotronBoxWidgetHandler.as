package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_705,RoomWidgetEcotronBoxOpenMessage.const_646,RoomWidgetEcotronBoxOpenedMessage.const_1166];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_705:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_646:
