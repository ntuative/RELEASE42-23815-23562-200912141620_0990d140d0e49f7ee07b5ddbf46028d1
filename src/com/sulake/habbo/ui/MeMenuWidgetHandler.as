   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_983,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_637,onFigureUpdate);
            }
            if(false)
            {
            ...
            if(false)
            {
               _container.method_2.events.removeEventListener(HabboHelpTutorialEvent.const_376,onHelpTutorialEvent);
               _container.method_2.events.removeEventListener(HabboHelpTutorialEvent.const_102,onHelpTutorialEvent);
            }
            _container = null;
         }
         _container = param1;
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_637,onFigureUpdate);
            _container.sessionDataManager.events.addEventListener(SessionCreditBalanceEvent.const_153,onCreditBalance);
         }
         var_25 = _container.inventory;
         if(var_25 != null)
         {
            (var_25 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_783,onAvatarEffectsChanged);
            (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_551,onHabboClubSubscriptionChanged);
         }
         ...
         if(false)
         {
            _container.method_2.events.addEventListener(HabboHelpTutorialEvent.const_376,onHelpTutorialEvent);
            _container.method_2.events.addEventListener(HabboHelpTutorialEvent.const_102,onHelpTutorialEvent);
         }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_376:
               _container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_382));
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_710);
         _loc1_.push(RoomWidgetDanceMessage.const_604);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_576);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_636);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_580);
         _loc1_.push(RoomWidgetStopEffectMessage.const_562);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1129);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_987);
         _loc1_.push(RoomWidgetToolbarMessage.const_500);
         _loc1_.push(RoomWidgetToolbarMessage.const_606);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_511);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1137);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_796);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_625);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_626);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_524);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_573);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1302);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_546);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_508);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_502);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_714));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_626:
               ...
               break;
            case RoomWidgetWaveMessage.const_710:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_604:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_576:
               if(var_25 != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_580:
               ...
               if(var_70 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_550)
               {
                  var_70.openCatalogPage(CatalogPageName.const_292,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_636:
               ...
               if(var_25 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_953:
                        var_70.openCatalogPage(CatalogPageName.const_1112,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_848:
                        var_25.toggleInventoryPage(InventoryCategory.const_246);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1225:
                        var_25.toggleInventoryPage(InventoryCategory.const_70);
                        break;
            ...
            case RoomWidgetStopEffectMessage.const_562:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_857:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.method_7)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1334:
                     break;
                  default:
                     Logger.log("MeMenuWidgetHandler: unknown icon widget type: " + _loc4_.method_7);
               }
               break;
            case RoomWidgetNavigateToRoomMessage.const_987:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_625:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_500:
               _loc5_ = param1 as RoomWidgetToolbarMessage;
               if(var_190)
               {
                  var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_25 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
               ...
               break;
            case RoomWidgetToolbarMessage.const_606:
               _loc6_ = param1 as RoomWidgetToolbarMessage;
               if(var_190)
               {
                  var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_424,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_511:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_377,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_864));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_377,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1187));
                     }
                  }
                  if(false && _container.method_2.events)
                  {
                     _container.method_2.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_689));
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_524:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_573:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_546:
            ...
            case RoomWidgetStoreSettingsMessage.const_508:
               ...
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_326,_container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_502:
               if(false && _container.method_2.events)
               {
                  _container.method_2.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_501));
               }
               break;
            default:
