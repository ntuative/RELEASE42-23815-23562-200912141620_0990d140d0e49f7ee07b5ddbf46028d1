package com.sulake.habbo.ui
{
   ...
   public class ChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleUserChooserRequest() : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_454,_loc3_));
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_327);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_462);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_620);
         return _loc1_;
      }
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         while(_loc4_ < _loc9_)
         {
            ...
            if(_loc8_ != null)
            {
               _loc5_ = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_289);
         ...
         _loc3_.sort(compareItems);
         _container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_459,_loc3_,_container.sessionDataManager.isAnyRoomController));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_462:
               ...
               break;
            case RoomWidgetRequestWidgetMessage.const_327:
               handleUserChooserRequest();
               break;
            case RoomWidgetRoomObjectMessage.const_620:
