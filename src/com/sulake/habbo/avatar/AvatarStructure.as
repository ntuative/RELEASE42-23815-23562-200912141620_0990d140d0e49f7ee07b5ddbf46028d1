package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_361:PartSetsData;
      
      private var var_1594:PartOffsetData;
      
      private var var_716:AvatarActionManager;
      
      private var var_150:IAssetLibrary;
      
      private var var_2196:IAssetLibrary;
      
      private var var_1294:Boolean = false;
      
      private var var_1593:AvatarRenderManager;
      
      private var var_431:FigureData;
      ...
      private var var_1318:AvatarStructureDownloadSet;
      
      private var var_594:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_150 = param2;
         var_2196 = param3;
         var_431 = new FigureData();
         var_361 = new PartSetsData();
         _animationData = new AnimationData();
         var_1318 = new AvatarStructureDownloadSet();
         var_594 = new AnimationManager();
         var_593 = param4;
         var_1594 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      {
         return var_716.getActionDefinitionWithState(param1);
      }
      ...
      private function init() : void
      {
         ...
         switch(var_593)
         {
            case AvatarType.HUMAN:
               _loc1_ = var_150.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_361.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_150.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_150.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_431.parse(_loc3_))
               {
                  return;
               }
               break;
            case AvatarType.PET:
               _loc1_ = var_150.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_361.parse(_loc1_))
               {
                  return;
               }
               _loc2_ = var_150.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc2_))
               {
                  return;
               }
               _loc3_ = var_150.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_431.parse(_loc3_))
               {
                  return;
               }
      ...
      {
         return var_716.getCanvasOffsets(param1,param2,param3);
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return var_716.getActionDefinition(param1);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_594.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_361.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_361.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1184[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_716.getDefaultActionType();
         var _loc7_:Array = var_361.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_594.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_431.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_431.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_361.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_361.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_593 + " ready to go!");
         if(var_593 == AvatarType.HUMAN)
         {
            var_361.getPartDefinition("ri").appendToFigure = true;
            var_361.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.HUMAN:
               var_1318.add(new AvatarStructureDownload(var_150,_loc5_,var_431));
               break;
            case AvatarType.PET:
         }
         var_1318.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_594.getAnimation(param1);
      }
      ...
      {
         var_716 = new AvatarActionManager(var_150,var_593);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_150.hasAsset("dance" + _loc1_))
         {
            ...
            var_594.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_431.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_431.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      
      public function sortActions(param1:Array) : Array
      {
         return var_716.sortActions(param1);
      }
   }
}
