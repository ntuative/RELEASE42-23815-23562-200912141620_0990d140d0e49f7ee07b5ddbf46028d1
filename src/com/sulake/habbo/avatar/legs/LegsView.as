package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_617["null"] = new AvatarEditorGridView(param1,FigureData.const_134,param2,param3);
         var_617["null"] = new AvatarEditorGridView(param1,FigureData.const_159,param2,param3);
         var_617["null"] = new AvatarEditorGridView(param1,FigureData.const_137,param2,param3);
         attachImages();
