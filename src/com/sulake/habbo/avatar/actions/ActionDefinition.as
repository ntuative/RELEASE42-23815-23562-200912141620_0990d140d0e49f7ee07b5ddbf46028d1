package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         var_1684 = parseInt(param1.@precedence);
         var_1681 = String(param1.@activepartset);
         var_1679 = String(param1.@assetpartdefinition);
         var_1683 = String(param1.@lay);
         var_1127 = String(param1.@geometrytype);
         var_1680 = Boolean(parseInt(param1.@main));
         var_1685 = Boolean(parseInt(param1.@const_342));
         var_1686 = Boolean(parseInt(param1.@animation));
      ...
      {
         return var_1110.concat(getTypePrevents(param1));
      }
