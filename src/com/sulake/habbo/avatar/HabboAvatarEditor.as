package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_894:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_894.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_895)
         {
            ...
            var_591["null"] = new FigureData(this);
            var_591["null"] = new FigureData(this);
            _loc1_ = var_591["null"];
            _loc2_ = var_591["null"];
            ...
            var_320 = new Map();
            var_320.add(AvatarEditorCategory.const_974,new GenericModel(this));
            var_320.add(AvatarEditorCategory.const_45,new HeadModel(this));
            var_320.add(AvatarEditorCategory.const_329,new TorsoModel(this));
            var_320.add(AvatarEditorCategory.const_1277,new LegsModel(this));
            var_320.add(AvatarEditorCategory.const_560,new WardrobeModel(this));
            var_895 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_320.getValue(AvatarEditorCategory.const_560);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_320.getValue(AvatarEditorCategory.const_560);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_894.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1291.clone() as IWindowContainer,param1,null,null,false);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1234)
               {
                  _loc19_ = true;
               }
               ...
               {
                  _loc6_ = new AvatarEditorGridItem(AvatarEditorView.var_1291.clone() as IWindowContainer,param1,_loc5_,_loc11_,_loc14_);
                  _loc3_.push(_loc6_);
               }
            }
         }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_320.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_360 == null)
            {
               var_360 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_54,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_360.addChild(_view.window);
               var_360.center();
               var_360.visible = false;
            }
         ...
         if(var_167 != null)
         {
            urlString = var_167.getKey("avatar.editor.url");
            try
            {
            }
            catch(e:Error)
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1061 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_551,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_894 = var_1061.getFigureData(AvatarType.HUMAN);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_893 = param3;
         var _loc4_:FigureData = var_591[param2];
         if(_loc4_ == null)
         {
            return;
         }
