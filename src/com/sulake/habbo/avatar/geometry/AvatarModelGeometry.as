package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1490:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var_852 = new Vector3D(0,0,10,0);
         super();
         var_492 = new Matrix4x4();
         var_696 = new Dictionary();
         var_1490 = new AvatarSet(param1.avatarset[0]);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            return _loc5_.getParts(var_492,var_852,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1490.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:IActionDefinition) : Array
      {
         ...
         for each(_loc8_ in _loc6_)
         {
            ...
            _loc11_ = _loc8_.getDistance(var_852);
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1490.findAvatarSet(param1);
         if(_loc3_ != null)
         {
