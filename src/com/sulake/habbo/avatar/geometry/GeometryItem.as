package com.sulake.habbo.avatar.geometry
{
   public class GeometryItem extends Node3D
   {
      ...
      {
         var _loc2_:Number = Math.abs(param1.z - this.transformedLocation.z - var_1085);
         var _loc3_:Number = Math.abs(param1.z - this.transformedLocation.z + var_1085);
