package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         var_1680 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         var_936 = new Dictionary();
         var_1370 = new Array();
         for each(_loc3_ in param1.avatarset)
         {
            _loc5_ = new AvatarSet(_loc3_);
            var_936[String(_loc3_.@id)] = _loc5_;
         }
