package com.sulake.habbo.avatar.pets
{
   ...
   public class PetDataManager implements IPetDataManager
   {
         ...
         for each(_loc3_ in param2)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc4_.hasAsset("petData"))
               {
                  ...
                  var_535.add(int(_loc6_.@species),new PetData(_loc6_));
               }
            }
         }
      }
      ...
      {
         return var_535.getValue(param1) as IPetData;
      }
      ...
      public function createAvatarFigureString(param1:String) : String
      {
         ...
         var _loc6_:PetData = var_535.getValue(_loc3_);
         if(_loc6_ == null)
         {
      ...
      {
         var _loc4_:PetData = var_535.getValue(param1);
         if(_loc4_ == null)
         {
      ...
      public function populateFigureData(param1:XML) : void
      {
         ...
         speciesKeys = var_535.getKeys();
         for each(key in speciesKeys)
         {
            petData = var_535.getValue(key);
            if(petData != null)
            {
               ...
               for each(breed in petData.breeds)
               {
                  ...
                  for each(targetSetName in targetSets)
                  {
                     ...
                     {
                        figurePart = figureTargetSet.const_1078.part.(@id == petData.species).(hasOwnProperty("palettemapid") && @palettemapid == breed.patternId)[0];
                        if(figurePart == null)
                        {
                        }
