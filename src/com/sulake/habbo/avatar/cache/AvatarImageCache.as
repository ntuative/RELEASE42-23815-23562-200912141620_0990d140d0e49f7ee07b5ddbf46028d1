package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1367:int = 60000;
      ...
      private var var_766:IAvatarImage;
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_520)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_347)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_78.getParts(param1,(var_766 as AvatarImage).getFigure(),_loc6_,var_1127,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_78.getCanvas(var_198,var_1127);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1320[param1])
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_829 || _loc32_ == AvatarAction.const_623) && (_loc6_ == AvatarBodyPartType.const_329 || _loc6_ == AvatarBodyPartType.const_1324 || _loc6_ == AvatarBodyPartType.const_1290) && _loc7_.color != null)
               {
