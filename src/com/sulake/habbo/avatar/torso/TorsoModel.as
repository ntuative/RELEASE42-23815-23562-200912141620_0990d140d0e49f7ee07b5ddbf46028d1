package com.sulake.habbo.avatar.torso
{
   ...
   public class TorsoModel implements IAvatarEditorCategoryModel
   {
      ...
      {
         var _loc3_:CategoryData = var_320[param1];
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:CategoryData = var_320[param1];
         if(_loc2_ == null)
         {
            var_320[param1] = _controller.generateDataContent(this,param1);
      ...
      private function updateCategoryData(param1:String) : void
      {
         ...
         var _loc4_:CategoryData = var_320[param1];
         if(_loc4_ == null)
         {
            return;
         }
