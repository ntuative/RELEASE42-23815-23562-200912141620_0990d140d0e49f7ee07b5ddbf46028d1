package com.sulake.habbo.avatar.alias
{
   ...
   public class AssetAliasCollection
   {
      ...
      private var var_1423:AssetLibraryCollection;
      ...
      public function AssetAliasCollection(param1:AssetLibraryCollection, param2:Array)
      {
         ...
         {
            _loc4_ = var_1423.getAssetLibraryByName(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function getAssetByName(param1:String) : IAsset
      {
         ...
         {
            _loc3_ = var_557[param1] as AssetAlias;
            param1 = _loc3_.link;
            _loc2_--;
         }
         return var_1423.getAssetByName(param1);
      }
      
      public function getAliasByName(param1:String) : AssetAlias
      {
         return var_557[param1] as AssetAlias;
      }
      
      public function hasAlias(param1:String) : Boolean
      {
         var _loc2_:AssetAlias = var_557[param1] as AssetAlias;
         return _loc2_ != null;
      }
