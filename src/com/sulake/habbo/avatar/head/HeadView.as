package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_617["null"] = new AvatarEditorGridView(param1,FigureData.const_112,param2,param3);
         var_617["null"] = new AvatarEditorGridView(param1,FigureData.const_138,param2,param3);
         var_617["null"] = new AvatarEditorGridView(param1,FigureData.const_143,param2,param3);
         var_617["null"] = new AvatarEditorGridView(param1,FigureData.const_141,param2,param3);
         var_617["null"] = new AvatarEditorGridView(param1,FigureData.const_131,param2,param3);
         attachImages();
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_617[var_1361];
         if(_loc2_ == null)
         {
            return;
         }
