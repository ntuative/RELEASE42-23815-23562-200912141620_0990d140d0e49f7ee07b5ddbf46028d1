package com.sulake.habbo.avatar.generic
{
   ...
   public class GenericView implements IAvatarEditorCategoryView
   {
      ...
      private var var_88:GenericModel;
      ...
      public function GenericView(param1:GenericModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_617["null"] = new AvatarEditorGridView(param1,FigureData.const_55,param2,param3);
         attachImages();
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_boy":
                  var_88.categorySwitch(FigureData.const_75);
                  param1.stopPropagation();
                  break;
               case "tab_girl":
                  var_88.categorySwitch(FigureData.const_77);
                  param1.stopPropagation();
            }
         }
      ...
      {
         var _loc4_:AvatarEditorGridView = var_617[param1];
         if(_loc4_ != null)
         {
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(var_88.controller.gender)
         {
         ...
         var _loc4_:AvatarEditorGridView = var_617[var_1361];
         if(_loc4_ == null)
         {
            return;
         }
