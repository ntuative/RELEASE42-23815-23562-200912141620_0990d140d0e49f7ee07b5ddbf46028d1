   ...
   public class Animation implements IAnimation
   {
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         if(param2.hasOwnProperty("canvas"))
         {
            ...
            {
               var_1230.push(new CanvasDataContainer(_loc6_));
            }
         }
         ...
         if(param2.hasOwnProperty("remove"))
         {
            ...
            {
               var_1229.push(new RemoveDataContainer(_loc7_));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               var_675.push(new AddDataContainer(_loc8_));
            }
         }
         var _loc3_:int = 0;
         for each(_loc4_ in param2.frame)
         {
            ...
            for each(_loc11_ in _loc4_.bodypart)
            {
               ...
               if(_loc10_ != null)
               {
                  _loc13_ = new AnimationLayerData(param1,_loc11_,AnimationLayerData.const_520,_loc3_,_loc10_);
                  _loc9_.push(_loc13_);
               }
            }
            for each(_loc12_ in _loc4_.fx)
            {
               ...
               _loc14_ = new AnimationLayerData(param1,_loc12_,AnimationLayerData.const_347,_loc3_,_loc10_);
               _loc9_.push(_loc14_);
               if(_loc10_ != null)
               {
               }
      ...
      public function getLayerData(param1:int, param2:String) : AnimationLayerData
      {
         ...
         for each(_loc3_ in getFrame(param1))
         {
            ...
            if(_loc3_.type == AnimationLayerData.const_347)
            {
               for each(_loc4_ in var_675)
               {
      ...
      public function getAnimatedBodyPartIds(param1:int) : Array
      {
         ...
         for each(_loc3_ in getFrame(param1))
         {
            if(_loc3_.type == AnimationLayerData.const_520)
            {
