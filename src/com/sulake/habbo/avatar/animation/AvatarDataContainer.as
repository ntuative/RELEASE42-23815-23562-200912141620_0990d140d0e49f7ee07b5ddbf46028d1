package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1319:Number = 1;
      
      private var _b:uint;
      
      private var var_1320:Number = 1;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         var_2159 = parseInt(_loc2_,16);
         var_2160 = parseInt(_loc3_,16);
         ...
         _colorTransform = new ColorTransform(var_1322,var_1320,var_1319,_alphaMultiplier);
         var_1031 = generatePaletteMapForGrayscale(var_2160,var_2159);
      }
      
      public function get reds() : Array
      {
         return var_1031.getValue("reds") as Array;
      }
      ...
      {
         return var_1031.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_1031.getValue("greens") as Array;
      }
      ...
      {
         return var_1031.getValue("alphas") as Array;
      }
