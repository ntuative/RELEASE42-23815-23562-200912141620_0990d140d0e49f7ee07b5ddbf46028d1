package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridView
   {
      ...
      private var var_860:IItemGridWindow;
      
      private var var_1516:IItemGridWindow;
      ...
      public function AvatarEditorGridView(param1:IAvatarEditorCategoryModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary)
      {
         ...
         if(_view != null)
         {
            var_860 = _view.findChildByName("thumbs") as IItemGridWindow;
            var_1516 = _view.findChildByName("colors") as IItemGridWindow;
         }
      }
      ...
      private function paletteEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = var_1516.getGridItemIndex(param1.window);
      ...
      {
         var _loc3_:IWindow = var_860.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_53)
         {
            _loc3_ = var_860.getGridItemIndex(param1.window);
