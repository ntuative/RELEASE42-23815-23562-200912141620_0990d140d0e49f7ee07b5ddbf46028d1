package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private const const_1568:int = 8947848;
      
      private const const_1567:int = 13421772;
      ...
      private var var_706:IPartColor;
      ...
      public function AvatarEditorColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         var_880 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc4_.colorTransform(_loc4_.rect,var_706.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_880.width,var_880.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_880,var_880.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
         ...
         if(false)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               _loc5_.bitmap.copyPixels(var_1309,var_1309.rect,new Point(0,0),null,null,true);
            }
         }
      }
