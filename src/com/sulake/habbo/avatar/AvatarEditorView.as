package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1291:IWindowContainer;
      ...
      private var var_1317:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1291 == null)
         {
            ...
            var_1291 = _controller.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         }
         if(var_1518 == null)
         {
      ...
      private function createWindow() : void
      {
         ...
         var_1317 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_607 = param1;
         var_1317.setSelected(var_1317.getSelectableByName(param1));
         _window.invalidate();
      }
