package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private var var_998:PaletteManager;
      ...
      {
         var _loc2_:* = null;
         _loc2_ = var_297.getValue(AvatarType.HUMAN) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
         _loc2_ = var_297.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc2_ != null)
         {
            _loc2_.initConfiguration(_habboConfiguration);
         }
      ...
      private function init() : void
      {
         ...
         var_998 = new PaletteManager(_loc1_,_loc3_);
         ...
         var_297.add(AvatarType.HUMAN,_loc5_);
         _loc5_ = new AvatarStructure(this,assets,_loc1_,AvatarType.PET);
         _loc5_.addEventListener(AvatarStructure.AVATAR_STRUCTURE_INIT,onStructureInit);
         var_297.add(AvatarType.PET,_loc5_);
      ...
      {
         var_623 = param1;
         if(var_623 == RenderMode.const_1273)
         {
            init();
         }
      }
      ...
      public function createPetImageNew(param1:int, param2:int, param3:uint, param4:String) : IAvatarImage
      {
         ...
         var _loc6_:AvatarStructure = var_297.getValue(AvatarType.PET) as AvatarStructure;
         if(_loc6_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:AvatarStructure = var_297.getValue(param1) as AvatarStructure;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:AvatarStructure = var_297.getValue(AvatarType.HUMAN) as AvatarStructure;
         if(_loc3_ == null)
         {
            return null;
         }
