package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel implements IAvatarEditorCategoryModel
   {
      ...
      public static const const_1507:String = "hot_looks";
      
      public static const const_1465:String = "my_looks";
      ...
      private var var_749:Boolean = true;
      ...
      public function WardrobeModel(param1:HabboAvatarEditor, param2:String = "")
      {
         ...
         var_517["null"] = new Array();
         var_517["null"] = new Array();
         var_517["undefined.index"] = 0;
         var_517["undefined.index"] = 0;
         initMyLooks();
         requestHotLooks();
      }
      ...
      private function onHotLooksConfiguration(param1:Event = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            for each(_loc5_ in _loc4_.habbo)
            {
               ...
               (var_517[_loc6_.gender] as Array).push(_loc6_);
            }
         }
         else
         {
