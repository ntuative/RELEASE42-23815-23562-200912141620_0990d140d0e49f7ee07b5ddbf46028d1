package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_670:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_670 = _window.findChildByName("mylooks") as IItemListWindow;
         var_553 = _window.findChildByName("hotlooks") as IItemListWindow;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "habboClubLink":
                  ...
                  var_88.controller.catalog.openCatalogPage(CatalogPageName.const_292,true);
            }
         }
      ...
      private function myLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            var_88.selectMyLook(var_670.getListItemIndex(param2.parent));
         }
      }
      ...
      public function updateHotLooks() : void
      {
         ...
         for each(_loc3_ in var_88.hotLooks)
         {
            ...
            {
               var_553.addListItem(_loc3_.view.window);
      ...
      public function updateMyLooks(param1:int) : void
      {
         ...
         else
         {
            ...
            while(false)
            {
               var_670.removeListItemAt(0);
            }
            for each(_loc2_ in var_88.myLooks)
            {
               var_670.addListItem(_loc2_.view.window);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_822 * 8 + var_553.getListItemIndex(param2.parent);
