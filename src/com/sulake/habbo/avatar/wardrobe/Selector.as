package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Selector
   {
      ...
      private var var_1162:BitmapData;
      ...
      public function Selector(param1:HabboAvatarEditor)
      {
         ...
         if(_window != null)
         {
            var_457 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
         _loc3_ = _assetLibrary.getAssetByName("selectOutfit") as BitmapDataAsset;
         var_962 = (_loc3_.content as BitmapData).clone();
         _loc3_ = _assetLibrary.getAssetByName("selectOutfit_over") as BitmapDataAsset;
         var_1162 = (_loc3_.content as BitmapData).clone();
         update(var_962);
      ...
      {
         var_457.bitmap = new BitmapData(var_457.width,var_457.height,true,16777215);
         var _loc2_:int = (0 - param1.width) / 2;
         var _loc3_:int = 0 - param1.height;
         var_457.bitmap.copyPixels(param1,param1.rect,new Point(_loc2_,_loc3_));
      }
