package com.sulake.habbo.avatar.structure
{
   ...
   public class PartSetsData implements IStructureData
   {
      ...
      {
         var _loc2_:ActivePartSet = var_729[param1.activePartSet];
         if(_loc2_ != null)
         {
            return _loc2_.parts;
         }
      ...
      public function parse(param1:XML) : Boolean
      {
         ...
         {
            var_729[String(_loc3_.@id)] = new ActivePartSet(_loc3_);
         }
         return true;
      }
      ...
      {
         return var_729[param1.activePartSet] as ActivePartSet;
      }
