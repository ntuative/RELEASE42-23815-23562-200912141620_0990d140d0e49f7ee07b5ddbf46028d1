package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      {
         var _loc3_:AssetLoaderStruct = var_590.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function bannerLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = var_590.getAssetByName(_loc2_.assetName);
         ...
         else if(param1.type == AssetLoaderEvent.const_30)
         {
            if(_events != null)
            {
               _events.dispatchEvent(new Event(HabboHotelViewEvent.const_402));
            }
      ...
      {
         var _loc3_:AssetLoaderStruct = var_590.loadAssetFromFile("hotel_view_banner_" + var_711,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
