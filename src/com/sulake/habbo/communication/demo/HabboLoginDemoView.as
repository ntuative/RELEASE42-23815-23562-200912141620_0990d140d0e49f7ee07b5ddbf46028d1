package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      private var var_322:HabboCommunicationDemo;
      ...
      {
         var_322.windowManager.removeWindow("habbo_login_window");
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_322.shockwaveClientUrl = var_114.shockwaveClientUrl;
         var_322.ssoTicket = var_114.ticket;
         var_114.removeEventListener(SSOTicket.const_314,onParsedTicketSuccess);
         var_114.removeEventListener(SSOTicket.const_228,onParsedTicketFailure);
         var_114 = null;
      ...
      private function windowEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(const_1361,"/");
      ...
      {
         var _loc1_:XmlAsset = (var_322 as Component).assets.getAssetByName("login_window") as XmlAsset;
         if(_loc1_ == null)
         {
            Logger.log("Could  not find embedded Window XML for Login Window, login_window");
            return;
         }
         _window = var_322.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_285,HabboWindowStyle.const_40,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         var _loc2_:XML = _loc1_.content as XML;
         var _loc3_:IWindowContainer = var_322.windowManager.buildFromXML(_loc2_) as IWindowContainer;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(const_1361,"/");
         if(_loc5_ != null)
         {
      ...
      private function initSSOTicket() : void
      {
         ...
         if(false)
         {
            _loc1_ = var_322.habboConfiguration.getKey("url.prefix",_loc1_);
            _loc1_ = _loc1_.replace("http://","");
            _loc1_ = _loc1_.replace("https://","");
         }
         var _loc2_:IHabboWebLogin = var_322.habboCommunication.habboWebLogin(name,password);
         var_114 = new SSOTicket(var_322.assets,_loc2_,_loc1_);
         var_114.addEventListener(SSOTicket.const_314,onParsedTicketSuccess);
         var_114.addEventListener(SSOTicket.const_228,onParsedTicketFailure);
      }
