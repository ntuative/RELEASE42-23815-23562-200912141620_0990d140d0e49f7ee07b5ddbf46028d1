package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_1695:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1353:ILogger;
      
      private var var_1117:String;
      
      private var var_1693:String;
      
      private const const_1361:String = "fuselogin";
      
      private var var_683:ICoreCommunicationManager;
      
      private var var_435:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            ...
            case DisconnectReasonEvent.const_875:
               ...
               break;
            case DisconnectReasonEvent.const_806:
               _loc3_ = _habboConfiguration.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_804:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1694)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_609 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_609);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1117,var_1693));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1361,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_435.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_435.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_1695);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1361,"/");
      ...
      {
         var_609 = _habboConfiguration.getKey("sso.ticket",null);
         var_1117 = _habboConfiguration.getKey("flash.client.url","");
         var_1693 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_168 == null)
         {
         ...
         if(var_609 != null)
         {
            var_74.mode = HabboConnectionType.const_372;
            var_74.initConnection(HabboConnectionType.const_253);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1353 = param2 as ILogger;
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_1695 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_74.mode)
         {
            case HabboConnectionType.const_372:
               _loc6_ = "";
               ...
               var_923 = _loc4_;
               var_168.loadBannerImage(_loc7_ + "?token=" + var_923,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1245:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1256:
               var_924 = generateRandomHexString(30);
               var_435 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_435.init(var_924);
               _loc8_ = var_435.getPublicKey(10);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_923);
         ...
         var_435 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_924 = generateRandomHexString(30);
            var_435.init(var_924);
            _loc12_ = var_435.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_33.events.addEventListener(RoomSessionEvent.const_101,onRoomSessionEnded);
      }
