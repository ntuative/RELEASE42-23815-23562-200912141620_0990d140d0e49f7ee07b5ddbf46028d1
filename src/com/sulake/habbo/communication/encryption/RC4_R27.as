package com.sulake.habbo.communication.encryption
{
   ...
   public class RC4_R27 extends RC4 implements IEncryption
   {
      ...
      private static const const_1055:int = 52;
      
      private static const WEDGIE_BYTE_MASK:uint = 64;
      
      private static const const_1054:String = "mWxFRJnGJ5T9Si0OMVvEBBm8laihXkN8GmH6fuv7ldZhLyGRRKCcGzziPYBaJom";
      ...
      private var var_1913:PseudoRandom;
      
      private var var_1407:IEncryption;
      ...
      {
         var _loc2_:int = 0;
         var _loc3_:ByteArray = CryptoTools.stringToByteArray(const_1054);
         var _loc4_:int = 0;
      ...
      override public function encipher(param1:ByteArray, param2:Boolean = false) : ByteArray
      {
         ...
         if(var_1407 != null)
         {
            ...
            _loc5_ = var_1407.encipher(_loc7_,true);
