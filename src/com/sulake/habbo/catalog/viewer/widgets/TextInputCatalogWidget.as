package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_926:ITextFieldWindow;
      ...
      {
         super.init();
         var_926 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_926 != null)
         {
            var_926.addEventListener(WindowKeyboardEvent.const_780,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_926.text));
      }
   }
}
