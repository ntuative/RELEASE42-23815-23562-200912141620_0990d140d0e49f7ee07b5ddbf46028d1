package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1080:IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_505 != null)
         {
            var_505.visible = false;
            var_505.destroyGridItems();
         }
         if(var_1080 != null)
         {
            var_1080.visible = false;
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(_loc2_.localizationId);
         if(_loc3_ != null)
         {
            var_1164.text = "${" + _loc3_.name + "}";
            var_1163.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1164.text = "${" + _loc2_.localizationId + "}";
            var_1163.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_408:
                  _loc4_ = var_1079.clone();
                  if(var_505 != null)
                  {
                     var_505.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_505,var_1080,var_1303);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_263:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_275,AvatarAction.const_552);
                              _loc13_.appendAction(AvatarAction.const_648,_loc6_.productClassId);
      ...
      {
         var_1164 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1163 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1327 = new Point(var_87.x,var_87.y);
         var_505 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1080 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_505 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1303 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1079 = _loc2_.content as BitmapData;
