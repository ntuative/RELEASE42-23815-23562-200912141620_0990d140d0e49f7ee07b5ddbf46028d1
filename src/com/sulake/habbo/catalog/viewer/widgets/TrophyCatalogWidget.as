package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_376.getWithIndex(var_192);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(var_455);
            if(_loc3_ == null)
            {
      ...
      override public function init() : void
      {
         ...
         _loc4_ = var_376.getWithIndex(var_192);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(var_455);
            if(_loc3_ == null)
            {
