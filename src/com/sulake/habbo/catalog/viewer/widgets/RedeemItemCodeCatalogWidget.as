package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_960:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_961 != null)
         {
            var_961.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_960 != null)
         {
            var_960.removeEventListener(WindowKeyboardEvent.const_109,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_961 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_961 != null)
         {
            var_961.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_960 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_960 != null)
         {
            var_960.addEventListener(WindowKeyboardEvent.const_109,windowKeyEventProcessor);
         }
      }
