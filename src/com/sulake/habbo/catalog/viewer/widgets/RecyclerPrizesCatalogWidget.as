package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_660.length)
         {
            createLevelItem(var_660[_loc2_]);
            _loc2_++;
         }
      }
      ...
      override public function init() : void
      {
         ...
         var_935 = new Map();
         var_660 = recycler.getPrizeTable();
         if(var_660 == null)
         {
            return;
         }
         ...
         var_1957 = _loc1_.content as XML;
         populateItemGrid();
         if(false && var_660[0].prizes.length > 0)
         {
            select(var_660[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1957) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1303) as IWindowContainer;
