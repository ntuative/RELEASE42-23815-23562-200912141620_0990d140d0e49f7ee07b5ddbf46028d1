package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_971:BitmapData = null;
      ...
      private var var_972:BitmapData = null;
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               switch(_loc4_.furnitureData.name)
               {
                  case "floor":
                     ...
                     {
                        var_791.push(String(_loc9_.@id));
                        var_1188.push(_loc2_);
                     }
                     break;
                  case "wallpaper":
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_971 != null && var_972 != null)
         {
            setRoomImage(var_971,var_972);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_167.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_225 >= 0)
               {
                  _loc9_ = _loc1_.children()[var_225];
                  if(_loc9_ != null)
                  {
                     var_1279 = _loc9_.@id;
                  }
         ...
         switch(param1)
         {
            ...
            case const_180:
               ...
               for each(_loc9_ in var_167.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_655 = _loc9_.children().length();
                  }
               }
            ...
            case const_182:
               ...
               for each(_loc10_ in var_167.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     var_654 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1279,var_1278,64,this,"window_romantic_wide");
