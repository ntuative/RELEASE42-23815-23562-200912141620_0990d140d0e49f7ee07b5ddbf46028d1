package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class PetsCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function getPurchaseParameters() : String
      {
         ...
         if(var_375 >= var_286.length)
         {
            return "";
         }
         var petColor:IPetColor = var_286[var_375] as IPetColor;
         var color:uint = petColor.rgb;
         var breed:IBreed = var_536[var_1394] as IBreed;
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var_375 = param1.index;
         if(var_375 < 0 || var_375 > var_286.length)
         {
            var_375 = 0;
         }
         updateImage();
      ...
      override public function init() : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_204,onTextWindowEvent);
         var_935 = new Map();
         ...
         var_773 = getPetTypeIndexFromProduct(_loc5_.localizationId);
         var_286 = [];
         var_536 = [];
         if(page && false && page.viewer.catalog)
         {
            ...
            {
               _loc11_ = _loc10_.avatarRenderManager.petDataManager.getPetData(var_773);
               if(_loc11_)
               {
         ...
         while(_loc6_ < var_536.length)
         {
            ...
            _loc3_.push(_loc4_.getKey(getRaceLocalizationKey(var_773,_loc12_.id),getRaceLocalizationKey(var_773,_loc12_.id)));
            _loc6_++;
         }
         var_935.add(var_773,_loc5_);
         ...
         events.addEventListener(WidgetEvent.const_909,onApproveNameResult);
      ...
      private function updateImage() : void
      {
         ...
         if(var_375 >= 0 && var_375 < var_286.length)
         {
            _loc7_ = var_286[var_375] as IPetColor;
            if(_loc7_ != null)
            {
               _loc2_ = uint(_loc7_.rgb);
            }
         }
         var _loc3_:IBreed = var_536[var_1394] as IBreed;
         var _loc4_:IAvatarImage = (page.viewer.catalog as HabboCatalog).avatarRenderManager.createPetImageNew(var_773,_loc3_.id,_loc2_,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.initActionAppends();
         _loc4_.appendAction(AvatarAction.const_275,AvatarAction.const_669);
