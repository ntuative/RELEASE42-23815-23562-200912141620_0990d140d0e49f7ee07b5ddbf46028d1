package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         var_1267 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_295 = null;
         for each(_loc1_ in var_1266)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1267) as IWindowContainer;
            ...
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_1050.width,var_1050.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(var_880.width,var_880.height,true,16777215);
               _loc5_.bitmap.copyPixels(var_880,var_880.rect,new Point(0,0),null,null,true);
