package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1376:int = 40;
      
      private const const_750:Array = [2,3,4,6,8,10,15,20,30,50,100];
      
      private const const_1572:int = 3;
      
      private const const_1359:int = 2;
      ...
      private function updateList(param1:Map) : void
      {
         ...
         updateStatusDisplay(const_1359,_loc7_.length);
         var _loc8_:int = 0;
         ...
         if(param1.type == WindowEvent.const_51)
         {
            if(param2.name == "search_drop")
            {
               ...
               if(marketPlace)
               {
                  ...
                  updateStatusDisplay(const_1047);
               }
            }
         }
         else if(param1.type == WindowKeyboardEvent.const_109)
         {
            if(param2.name == "search_input")
            {
               if(_loc4_ && _loc4_.text.length >= const_1376)
               {
                  _loc4_.text = _loc4_.text.substr(0,const_1376);
               }
            }
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            switch(param2.name)
            {
               ...
               case "search_button":
                  ...
                  if(marketPlace && _loc4_.text.length >= const_1572)
                  {
