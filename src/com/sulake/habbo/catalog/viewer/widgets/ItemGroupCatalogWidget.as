package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_504[var_903] as Array;
      ...
      {
         var _loc2_:Offer = var_504[var_903][var_1606];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_450 || _loc1_.pricingModel == Offer.const_445)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc3_.productType == ProductTypeEnum.const_79 || _loc3_.productType == ProductTypeEnum.const_88)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        ...
                        if(var_902.indexOf(_loc5_) == -1)
                        {
                           var_902.push(_loc5_);
                           var_504.push(new Array());
                        }
                        _loc6_ = var_902.indexOf(_loc5_);
                        (var_504[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_504)
         {
            if(var_1606 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1606] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_903 = var_875.getGridItemIndex(param1.view);
