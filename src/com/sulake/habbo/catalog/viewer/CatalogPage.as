package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1358:String = "ctlg_";
      ...
      private var var_1277:EventDispatcher;
      ...
      {
         return _localization.hasLinks(var_855);
      }
      ...
      {
         var _loc2_:String = const_1358 + param1;
         ...
         var_1306 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1306) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1277;
            _loc2_.init();
         }
         var_1277.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1277.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_855);
      }
