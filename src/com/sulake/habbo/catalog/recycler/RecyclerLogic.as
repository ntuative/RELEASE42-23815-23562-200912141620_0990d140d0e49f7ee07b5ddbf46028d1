package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1494)
         {
            case RecyclerStatusMessageEvent.const_1291:
               var_273 = const_340;
               if(_view == null)
               {
                  return;
            ...
            case RecyclerStatusMessageEvent.const_895:
               ...
               break;
            case RecyclerStatusMessageEvent.const_1131:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1494 != RecyclerStatusMessageEvent.const_895;
      }
      
      private function get statusActive() : Boolean
      {
         return var_273 != const_763;
      }
      ...
      {
         return active && var_273 == const_340;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_878:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1262:
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!var_70.returnInventoryFurniFromRecycler(var_103[param1].id))
         {
            return;
         }
         var_103[param1] = null;
