package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private var var_2237:IWindowContainer;
      ...
      private var var_1464:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(var_1464 == 4294967295)
            {
               var_1464 = _loc1_.color;
            }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1246;
            }
         }
      }
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            _window = navigator.catalog.windowManager.buildFromXML(var_1463) as IWindowContainer;
         }
         else
         {
      ...
      {
         _list = navigator.catalog.windowManager.buildFromXML(var_1462) as IItemListWindow;
         if(_list == null)
         {
