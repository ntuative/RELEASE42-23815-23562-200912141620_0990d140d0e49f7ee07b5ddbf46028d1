package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog
   {
      ...
      private var var_522:ITextWindow;
         ...
         switch(_loc2_)
         {
            case "button_ok":
               if(var_523)
               {
                  ...
                  HabboCatalog(var_70).purchaseProduct(var_661,var_171,var_939,true,_loc5_,_loc6_);
               }
               else
               {
                  HabboCatalog(var_70).purchaseProduct(var_661,var_171,var_939);
               }
               dispose();
               break;
            case "button_cancel":
      ...
      private function showDialog() : void
      {
         ...
         if(_window == null)
         {
            _window = var_70.windowManager.createWindow("OrderInfo","${catalog.purchase.confirmation.dialog.title}",HabboWindowType.const_285,HabboWindowStyle.const_40,0 | 0 | 0,new Rectangle(10,10,300,180),null) as IFrameWindow;
         }
         else
         {
         ...
         if(_loc4_)
         {
            ...
            _loc17_.addEventListener(WindowEvent.const_514,onDeActivateGift);
            _loc17_.addEventListener(WindowEvent.const_521,onActivateGift);
         ...
         var _loc11_:IProductData = var_70.getProductData(var_171.localizationId);
         ...
         var _loc14_:String = "";
         var _loc15_:String = "";
         switch(var_171.priceType)
         {
            case Offer.const_279:
               _loc16_ = _localization.getLocalization("catalog.purchase.confirmation.dialog.price.credits");
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.credits","credits",var_171.priceInCredits.toString());
            ...
            case Offer.const_455:
               ...
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.credits+pixels","credits",var_171.priceInCredits.toString());
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.credits+pixels","pixels",var_171.priceInPixels.toString());
               _loc13_ = _loc16_.value;
            ...
            case Offer.const_470:
               ...
               _localization.registerParameter("catalog.purchase.confirmation.dialog.price.pixels","pixels",var_171.priceInPixels.toString());
               _loc13_ = _loc16_.value;
      ...
      private function updateSuggestions(param1:Array, param2:IWindow) : void
      {
         ...
         if(var_130 == null)
         {
            ...
            var_130 = var_70.windowManager.buildFromXML(_loc5_.content as XML) as IItemListWindow;
            if(var_130 != null)
            {
               var_522 = var_130.getListItemAt(0) as ITextWindow;
               var_522.procedure = suggestionsEventHandler;
            }
         }
         if(var_130 == null || var_522 == null)
         {
            return;
         }
         var_130.removeListItems();
         ...
         {
            _loc6_ = var_522.clone() as ITextWindow;
            if(_loc6_ != null)
            {
               _loc6_.text = _loc3_;
               var_130.addListItem(_loc6_);
            }
         }
         _loc4_ = new Rectangle();
         param2.getGlobalRectangle(_loc4_);
         var_130.setGlobalPosition(new Point(_loc4_.left,_loc4_.bottom + 10));
      }
   }
}
