package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1552.clone());
         ...
         new OpenRoomTool(var_58,var_57,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
      ...
      {
         var_1552 = IWindowContainer(var_57.getXmlWindow("roomvisits_row"));
         ...
         var_58 = IFrameWindow(var_57.getXmlWindow("roomvisits_frame"));
