package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_57.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_57,WindowTracker.const_931,_data.userId),_callerFrame,var_1030,false,true);
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_857.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_57.getXmlWindow("user_info"));
            var_857.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_57.windowTracker.show(new ModActionCtrl(var_57,_data.userId,_data.userName,var_1215),_callerFrame,var_1030,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_57.windowTracker.show(new RoomVisitsCtrl(var_57,_data.userId),_callerFrame,var_1030,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_57.windowTracker.show(new SendMsgsCtrl(var_57,_data.userId,_data.userName,var_1215),_callerFrame,var_1030,false,true);
      }
