package com.sulake.habbo.moderation
{
   ...
   public class UserInfoFrameCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_814:UserInfoCtrl;
      ...
      {
         var_58 = IFrameWindow(var_57.getXmlWindow("user_info_frame"));
         var_58.caption = "User Info";
         var _loc1_:IWindow = var_58.findChildByTag("close");
         _loc1_.procedure = onClose;
         var_814 = new UserInfoCtrl(var_58,var_57,"",true);
         var_814.load(var_58.content,_userId);
         var_58.visible = true;
      }
