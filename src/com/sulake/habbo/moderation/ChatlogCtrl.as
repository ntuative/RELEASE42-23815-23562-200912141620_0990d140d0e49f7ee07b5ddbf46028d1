package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         var_795 = IWindowContainer(var_57.getXmlWindow("chatlog_roomheader"));
         var_794 = IWindowContainer(var_57.getXmlWindow("chatlog_chatline"));
         var_461 = new Timer(300,1);
         var_461.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_58 = IFrameWindow(var_57.getXmlWindow("chatlog_frame"));
         ...
         var_57.connection.send(var_1312);
         var_57.messageHandler.addChatlogListener(this);
      }
      ...
      public function onChatlog(param1:String, param2:int, param3:int, param4:Array, param5:Dictionary) : void
      {
         ...
         var_57.messageHandler.removeChatlogListener(this);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_795.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_58,var_57,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_794.clone());
         _loc4_.color = var_1192[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_58,var_57,_loc6_,param2.chatterId);
         }
