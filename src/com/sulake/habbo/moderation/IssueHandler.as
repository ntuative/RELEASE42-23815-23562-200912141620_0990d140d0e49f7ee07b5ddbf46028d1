package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_943:UserInfoCtrl;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.releaseBundle(var_115.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_369 = new UserInfoCtrl(_window,var_62,_loc3_.message);
         var_943 = new UserInfoCtrl(_window,var_62,_loc3_.message);
         var_369.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_115.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_943.load(_loc4_,var_115.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.closeBundle(var_115.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var_62.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_62,WindowTracker.const_850,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_62 != null && false && var_115 != null)
         {
            var_62.issueManager.removeHandler(var_115.id);
         }
         this.dispose();
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.closeBundle(var_115.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.closeBundle(var_115.id,3);
         checkAutoHandling();
         dispose();
      }
