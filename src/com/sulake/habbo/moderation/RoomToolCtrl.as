package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1001:ICheckBoxWindow;
      ...
      private var var_772:IDropMenuWindow;
      
      private var var_680:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_57.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_57,WindowTracker.const_661,_data.flatId),var_58,false,false,true);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + var_397);
         if(param1.flatId != var_397)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + var_397);
            return;
         }
         _data = param1;
         populate();
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_57.windowTracker.show(new UserInfoFrameCtrl(var_57,_data.ownerId),var_58,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_680.isSelected);
         var_57.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1149,_loc2_,var_385.text,"",""));
         if(false)
         {
            var_57.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_1001.isSelected,var_1000.isSelected,var_680.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1218);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1241);
      }
      ...
      public function populate() : void
      {
         ...
         var_772 = IDropMenuWindow(var_58.findChildByName("msgTemplatesSelect"));
         prepareMsgSelect(var_772);
         var_772.procedure = onSelectTemplate;
         var_680 = ICheckBoxWindow(var_58.findChildByName("kick_check"));
         var_1001 = ICheckBoxWindow(var_58.findChildByName("lock_check"));
         var_1000 = ICheckBoxWindow(var_58.findChildByName("changename_check"));
         ...
         var_57.disableButton(var_57.initMsg.bobbaFilterPermission,var_58,"bobba_filter_but");
      ...
      {
         var_58 = IFrameWindow(var_57.getXmlWindow("roomtool_frame"));
         var_57.messageHandler.addRoomInfoListener(this);
         var_57.connection.send(new GetModeratorRoomInfoMessageComposer(var_397));
         Logger.log("BEGINNING TO SHOW: " + var_397);
      }
   }
}
