package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1443:IIssueBrowserView;
      
      private const const_1579:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1580:String = "picked_issues";
      ...
      private const const_1581:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_232:ITabContextWindow;
      
      private var var_1441:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_339.view.width = var_232.container.width;
         var_339.view.height = var_232.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1581:
               if(var_1442 == null)
               {
                  var_1442 = new MyIssuesView(issueManager,this,var_232.container);
               }
               return var_1442;
            case const_1579:
               if(var_1443 == null)
               {
                  var_1443 = new OpenIssuesView(issueManager,this,var_232.container);
               }
               return var_1443;
            case const_1580:
               if(var_1441 == null)
               {
                  var_1441 = new PickedIssuesView(issueManager,this,var_232.container);
               }
               return var_1441;
            default:
               return null;
