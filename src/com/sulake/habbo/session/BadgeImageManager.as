package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1174:String = "normal_badge";
      
      public static var loading_icon_png:Class = BadgeImageManager_loading_icon_png;
      
      public static const const_984:String = "group_badge";
       
      
      private const const_1380:String = "badge_";
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(const_1380,"");
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = const_1380 + param1;
         ...
         switch(param2)
         {
            case const_1174:
               if(var_167 != null)
               {
                  _loc5_ = var_167.getKey("image.library.url","http://images.habbohotel.com/c_images/");
            ...
            case const_984:
               if(var_167 != null)
               {
                  if(var_167 != null)
                  {
                     _loc5_ = var_167.getKey("group.badge.url");
