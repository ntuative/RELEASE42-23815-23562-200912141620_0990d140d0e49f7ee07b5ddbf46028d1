   ...
   public class GroupDetailsView
   {
      ...
      private function showGroupInfoDialog(param1:int) : void
      {
         ...
         if(var_152 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_152 = _sessionManager.windowManager.createWindow("habbo_group_details_window","${group.window.title}",HabboWindowType.const_285,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,300,220),null) as IWindowContainer;
      ...
      private function onGroupDetailsEvents(param1:Event) : void
      {
         ...
         var _loc3_:HabboGroupDetails = _sessionManager.getGroupDetails(var_1662);
         switch(_loc2_.name)
         {
