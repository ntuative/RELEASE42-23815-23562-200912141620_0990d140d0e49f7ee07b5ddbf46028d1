package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_901:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_277 && _connection != null)
         {
      ...
      {
         return var_901 as IUserDataManager;
      }
