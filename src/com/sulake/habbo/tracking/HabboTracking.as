package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      private var var_366:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_921:int = -1;
      
      private var var_1113:LagWarningLogger = null;
      
      private var var_748:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1113 = new LagWarningLogger();
         var_1114 = new Array(const_738);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1341,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1109,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_578,String(false));
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_697:
               trackLoginStep(HabboLoginTrackingStep.const_14,String(_communication.port));
               break;
      ...
      {
         var_167 = IHabboConfigurationManager(param2);
         if(var_167)
         {
            Component(var_167).events.addEventListener(HabboConfigurationEvent.const_17,onConfigurationLoaded);
            if(var_213 != null)
            {
               var_213.configuration = var_167;
            }
            if(var_214 != null)
            {
               var_214.configuration = var_167;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_432.events.addEventListener(AdEvent.const_380,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_578,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_402,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_353:
               var_1113.registerWarning(LagWarningLogger.const_774);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_167)
            {
               var_167.release(new IIDHabboConfigurationManager());
               var_167 = null;
            }
            if(_localization)
            {
            ...
            if(var_748)
            {
               var_748.release(new IIDHabboWindowManager());
               var_748 = null;
            }
            if(var_432)
            {
            ...
            if(var_166)
            {
               if(true)
               {
                  ...
                  Component(var_166).events.removeEventListener(HabboFriendListTrackingEvent.const_325,onFriendlistTrackingEvent);
               }
            ...
            if(var_366)
            {
               if(true)
               {
                  var_366.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_366.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_366.release(new IIDHabboHelp());
               var_366 = null;
            }
            if(_roomEngine)
            {
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_167)
         {
            Component(var_167).events.removeEventListener(HabboConfigurationEvent.const_17,onConfigurationLoaded);
         }
      }
      ...
      {
         var_366 = param2 as IHabboHelp;
         var_366.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_366.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         var_748 = IHabboWindowManager(param2);
         if(var_748)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_921 > -1 && _loc2_ < var_921)
         {
            ++var_1351;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1351);
         }
         if(var_921 > -1 && _loc2_ - var_921 > 15000)
         {
            ++var_1352;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1352);
         }
         var_921 = _loc2_;
         if(var_214 != null)
         {
         ...
         if(var_1113 != null)
         {
            var_1113.update(param1);
         }
      }
      
      public function trackLoginStep(param1:String, param2:String = null) : void
      {
         if(var_167 != null && Boolean(var_167.getKey("processlog.enabled") == false))
         {
            return;
         }
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_237,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_166).events.addEventListener(HabboFriendListTrackingEvent.const_325,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:int = 0;
         if(param1.critical && !var_1689)
         {
            var_1689 = true;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1322,new Date().getTime().toString());
            if(var_167)
            {
               if(var_167.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = var_167.getKey("client.fatal.error.url");
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         else if(param1.type == HabboHotelViewEvent.const_402)
         {
