package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         var_1379 = getTimer();
         var_450.add(var_1141,var_1379);
         _connection.send(new LatencyPingRequestMessageComposer(var_1141));
         ++var_1141;
      }
      ...
      public function init() : void
      {
         ...
         var_1380 = int(var_167.getKey("latencytest.interval"));
         var_1382 = int(var_167.getKey("latencytest.report.index"));
         var_1775 = int(var_167.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var_157.push(_loc4_);
         if(var_157.length == var_1382 && var_1382 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - var_1381) > var_1775 || var_1381 == 0)
            {
               var_1381 = _loc9_;
