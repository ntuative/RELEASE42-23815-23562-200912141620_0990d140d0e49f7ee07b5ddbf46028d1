   ...
   public class HabboNotificationViewManager implements ICoreUpdateReceiver
   {
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         while(_loc2_ < var_229.length)
         {
            ...
            if(_loc1_ + HabboNotificationItemView.const_666 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_666 + const_486;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(_assetLibrary.getAssetByName("layout_notification_xml"),_windowManager,var_1941,var_387,var_190);
      ...
      {
         return getNextAvailableVerticalPosition() + HabboNotificationItemView.const_666 < 540;
      }
   }
}
