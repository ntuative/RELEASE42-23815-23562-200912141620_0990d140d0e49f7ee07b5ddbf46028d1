package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1541 = param2;
         var_555 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_104,onBadgeImageReady);
         ...
         var_1832 = param5.getKey("notifications.text.achievement_facebook");
      ...
      public function dispose() : void
      {
         if(var_555 != null)
         {
            var_555.events.removeEventListener(BadgeImageReadyEvent.const_104,onBadgeImageReady);
            var_555 = null;
         }
         if(_window != null)
         {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_644,var_1832);
               }
               dispose();
               break;
      ...
      {
         _localizations.registerParameter(param1,"badge_name",_localizations.getKey("badge_name_" + var_644,var_644));
         _localizations.registerParameter(param1,"badge_desc",_localizations.getKey("badge_desc_" + var_644,var_644));
         _localizations.registerParameter(param1,"level",var_1541.toString());
