package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1102:String = "pixelbalance";
      
      private static const const_1103:String = "credits";
      
      private static const const_1104:String = "inventory";
      
      private static const const_1099:String = "friendlist";
      
      private static const const_1100:String = "selectfurni";
      
      private static const const_1105:String = "selectbadge";
      ...
      private var var_1287:IHabboToolbar;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_856);
         }
         var _loc6_:Map = var_856["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1127);
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_878)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1230);
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_2154)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_793);
            var_2154 = true;
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1061.createPetImage(_loc2_.pet.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_863,_loc5_);
         }
      }
      ...
      {
         var _loc1_:Array = var_1028.splice(0,1);
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = var_1061.createPetImage(_loc2_.figure,AvatarScaleType.const_50);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      {
         if(param2.type == WindowEvent.const_152 || param2.type == WindowEvent.const_677)
         {
            param1.dispose();
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
            ...
            if(_loc4_.products.length > 0)
            {
               ...
               switch(_loc15_.productType)
               {
                  ...
                  case CatalogPageMessageProductData.const_79:
                     ...
                     break;
                  case CatalogPageMessageProductData.const_263:
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_793,_loc5_);
         }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = var_1061.createAvatarImage(param2,AvatarScaleType.const_50);
         if(_loc7_ != null)
         {
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var_1028.push(_loc8_);
         return var_1028.length;
      }
      ...
      {
         var_1287 = IHabboToolbar(param2);
         var_1287.events.addEventListener(HabboToolbarEvent.const_81,onHabboToolbarEvent);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_194);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_555.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_778);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_778);
            }
         }
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_81)
         {
            ...
            var_410 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_856["styles"],var_856["view"],var_1287);
            ...
            var_555.events.addEventListener(BadgeImageReadyEvent.const_104,onBadgeImage);
            var_1287.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
