package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, ICoreUpdateReceiver
   {
      ...
      private static const const_1082:String = "tile_cursor";
      
      private static const const_273:int = -1;
       
      
      private var var_390:IRoomObjectVisualizationFactory = null;
      ...
      private var var_561:NumberBank;
      ...
      private var var_685:RoomMessageHandler = null;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         super(param1,param2);
         var_302 = new Map();
         var_561 = new NumberBank(1000);
         var_1015 = new Map();
         var_301 = new Map();
         var_71 = new RoomObjectEventHandler(this);
         var_685 = new RoomMessageHandler(this);
               ...
               if(_loc8_ != null)
               {
                  ...
                  if(_loc11_ != null)
                  {
                     ...
                     if(_loc14_ != null)
                     {
                        ...
                        if(_loc15_ != null)
                        {
                           _loc16_ = _loc15_.getNumber(RoomVariableEnum.const_709) - 0.5;
                           _loc17_ = _loc15_.getNumber(RoomVariableEnum.const_720) - 0.5;
                           _loc18_ = _loc15_.getNumber(RoomVariableEnum.const_704) + 0.5;
                           _loc19_ = _loc15_.getNumber(RoomVariableEnum.const_679) + 0.5;
      ...
      override public function dispose() : void
      {
         ...
         if(var_390 != null)
         {
            var_390.release(new IIDRoomObjectVisualizationFactory());
            var_390 = null;
         }
         if(var_49 != null)
         {
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_699);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_589);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_725);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_805);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_948);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_965) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_933);
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_526,var_121,var_120,param2,param3));
            }
         }
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_537,param3);
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_49 != null)
         {
            ...
            var_49.addObjectUpdateCategory(RoomObjectCategoryEnum.const_242);
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_289,param4,true);
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_243,param1,param2,param3,RoomObjectCategoryEnum.const_32));
         }
         return true;
      }
      ...
      {
         if(_roomObjectFactory == null || var_390 == null || var_49 == null || _roomRendererFactory == null || _communication == null || _habboConfiguration == null || !var_2051)
         {
            return;
         }
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_273,RoomObjectCategoryEnum.const_56);
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1154,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_757,RoomObjectCategoryEnum.const_242);
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = getRoomCanvas(var_121,var_120,var_1257);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = getRoomCanvas(var_121,var_120,var_1257);
         if(_loc1_ != null)
         {
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_390 = param2 as IRoomObjectVisualizationFactory;
         if(var_26 != null)
         {
            var_26.visualizationFactory = var_390;
         }
         initializeRoomManager();
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(_roomObjectFactory != null)
         {
            if(false)
            {
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_211,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_369,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMouseEvent.const_348,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_251,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectStateChangeEvent.const_582,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectWidgetRequestEvent.const_90,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_397,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_422,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectFurnitureActionEvent.const_473,roomObjectEventHandler);
               ...
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_449,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectMoveEvent.const_419,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_237,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_384,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_313,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomAdEvent.const_321,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_357,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_782,roomObjectEventHandler);
               _roomObjectFactory.events.addEventListener(RoomObjectRoomActionEvent.const_451,roomObjectEventHandler);
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_635) != 0)
         {
            return false;
         }
         if(var_71 != null)
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_243,param1,param2,param3,RoomObjectCategoryEnum.const_37));
         }
         return true;
      }
            ...
            if(_loc13_ != null && _loc13_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_37:
                     _loc10_ = _loc13_.getModel().getString(RoomObjectVariableEnum.const_158);
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_295);
         }
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_617)
         {
            var_2051 = true;
            initializeRoomManager();
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_243,param1,param2,param3,RoomObjectCategoryEnum.const_29));
         }
         return true;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_432.events.addEventListener(AdEvent.const_380,showRoomAd);
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0) : ImageResult
      {
         ...
         var _loc10_:int = var_561.reserveNumber();
         ...
         switch(_loc11_)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               break;
            case RoomObjectCategoryEnum.const_37:
               _loc12_.getModelController().setString(RoomObjectVariableEnum.const_158,param2);
               break;
            case RoomObjectCategoryEnum.const_56:
               if(param2 != null)
               {
                  ...
                  if(_loc16_.length >= 3)
                  {
                     ...
                     _loc20_.addPlane(RoomPlaneData.const_140,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
                     _loc20_.addPlane(RoomPlaneData.const_147,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
                     _loc20_.addPlane(RoomPlaneData.const_147,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc20_.addPlane(RoomPlaneData.const_240,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     _loc21_ = _loc20_.getXML();
                     _loc12_.getEventHandler().initialize(_loc21_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_586,_loc17_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_531,_loc18_);
                     _loc12_.getModelController().setString(RoomObjectVariableEnum.const_667,_loc19_);
                     if(param6 != null)
                     {
                        _loc22_ = null;
                        _loc23_ = "undefined_" + _loc10_;
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_452,_loc23_,param6,new Vector3d(2,0,1.75));
         ...
         {
            var_1015.add(String(_loc10_),param5);
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_794,param4,true);
         }
         else
         {
            _loc9_.disposeObject(_loc10_,_loc11_);
            var_561.freeNumber(_loc10_ - 1);
            _loc8_.id = 0;
         }
         _loc14_.dispose();
         return _loc8_;
      ...
      {
         return getObject(getRoomIdentifier(param1,param2),const_758,RoomObjectCategoryEnum.const_242);
      }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               _loc11_.x = var_1470 - _loc12_.width / 2;
               _loc11_.y = var_1471 - _loc12_.height / 2;
            }
            if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
            {
               ...
               if(param4 == MouseEvent.CLICK)
               {
                  if(events != null)
                  {
                     events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_399,var_121,var_120,-1,RoomObjectCategoryEnum.const_217));
                  }
                  _loc13_ = "null";
               }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = getRoomCanvas(var_121,var_120,var_1257);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = var_1470 - _loc6_.data.width / 2;
               _loc11_.y = var_1471 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(var_26 != null)
         {
            ...
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_304,param1.image,true);
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_926,param1.adWarningL,true);
            var_26.addGraphicAsset(var_26.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_812,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_802,RoomObjectVariableEnum.const_304,param1.clickUrl);
      ...
      private function onHabboConfigurationInit(param1:Event) : void
      {
         if(var_26 != null)
         {
            _events.addEventListener(RoomContentLoader.const_617,onContentLoaderReady);
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_794);
               ...
               var_561.freeNumber(_loc10_ - 1);
               _loc13_ = var_1015.remove(String(_loc10_)) as IGetImageListener;
      ...
      {
         return getRoomObjectBoundingRectangle(var_121,var_120,const_273,RoomObjectCategoryEnum.const_56,param1);
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_957,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_635,1,true);
            _loc13_ = parseInt(_habboConfiguration.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_986,_loc13_,true);
            if(var_26 != null)
            {
         ...
         else
         {
            ...
            _loc7_.setNumber(RoomVariableEnum.const_635,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_699,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_709,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_704,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_720,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_679,_loc19_);
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_537,param3);
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_452,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_188);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_589,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_725,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_589,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_725,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_805,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_948,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_758,const_1082,RoomObjectCategoryEnum.const_242);
         _loc7_.createRoomObject(const_757,OBJECT_TYPE_SELECTION_ARROW,RoomObjectCategoryEnum.const_242);
         return _loc7_;
      }
