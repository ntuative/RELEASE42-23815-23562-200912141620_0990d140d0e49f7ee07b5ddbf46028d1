package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_687,"");
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_802:
                  _loc2_.setString(RoomObjectVariableEnum.const_304,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_687,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_350,Number(true));
                  var_949 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_986);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_364)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_687);
                  if(_loc7_ != null && _loc7_.indexOf("http") == 0)
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_237,_loc5_,_loc6_,_loc7_));
