package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1364:int = 1500;
      
      private var var_1365:int = 255;
      
      private var var_1366:int = 255;
      
      private var var_1125:uint = 16777215;
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_537:
                  _loc2_.setString(RoomObjectVariableEnum.const_586,_loc3_.value);
                  break;
               ...
               case RoomObjectRoomUpdateMessage.const_598:
                  _loc2_.setString(RoomObjectVariableEnum.const_667,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_452:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_188)
                  {
                     _loc8_ = "null";
                  }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_619,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_83.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_94,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1228,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1142,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1118,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_94,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_147 || _loc13_ == RoomPlaneData.const_240)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_755)
         {
            ...
            _loc5_.setNumber(RoomObjectVariableEnum.const_619,_loc2_);
         }
      }
   }
}
