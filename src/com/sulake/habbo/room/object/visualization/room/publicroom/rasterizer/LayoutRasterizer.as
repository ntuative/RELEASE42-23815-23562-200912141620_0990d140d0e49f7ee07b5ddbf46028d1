package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_885:Point = null;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_887 = param1;
         var _loc3_:LayoutRasterizerData = var_66.getValue(var_589);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1058 = RoomObjectVariableEnum.const_926;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1058 = RoomObjectVariableEnum.const_812;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_887 + _adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(var_887 + _adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(var_887 + _adBgIndex);
            _loc5_ = param1.getSprite(var_887 + _adImgIndex);
         }
         ...
         {
            exchangeElementGraphics("billboard_img",var_1058);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_364;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_1573);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_589)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_886 = var_66.getValue(var_589);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_66.getValue(var_589);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_885.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_885.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_314.indexOf(_loc10_) >= 0 && var_425)
            {
               param1 = var_314.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_424[param1]);
                  if(_loc9_ != null)
                  {
                     param2.asset = _loc9_.asset;
                  }
               ...
               if(true)
               {
                  param2.alpha = var_426[param1];
               }
               var_314.splice(param1,1);
