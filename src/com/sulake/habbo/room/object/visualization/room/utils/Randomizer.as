package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1400:int = 16777216;
      ...
      private var var_2249:int = 5;
      
      private var var_1436:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1436 * param2);
      }
      ...
      {
         var _loc1_:int = var_2248 * var_1226 + var_2249;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
