package com.sulake.habbo.room.object.visualization.room.publicroom
{
   ...
   public class PublicRoomVisualization extends RoomVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc5_:* = !Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_350));
         if(_loc4_ != "" && data != null)
         {
      ...
      private function initializeLayout(param1:IRoomGeometry) : void
      {
         ...
         if(data != null)
         {
            var_1043 = spriteCount;
            _loc2_ = object.getModel();
            _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_957);
            ...
            {
               data.layoutRasterizer.setElementToSprite(_loc4_,getSprite(_loc4_ + var_1043));
               _loc4_++;
            }
            data.layoutRasterizer.initializeAds(var_1043,this);
         }
         var_1911 = true;
      }
