package com.sulake.habbo.room.object.visualization.room.rasterizer.animated
{
   ...
   public class LandscapeRasterizer extends PlaneRasterizer
   {
      ...
      private function parseLandscapes(param1:XML) : void
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc6_,["id"]))
            {
               ...
               if(var_321.getValue(_loc7_) == null)
               {
                  var_321.add(_loc7_,_loc9_);
               }
               else
               {
                  _loc9_.dispose();
      ...
      {
         var _loc13_:LandscapePlane = var_321.getValue(param2);
         if(_loc13_ == null)
         {
            _loc13_ = var_321.getValue(const_729);
         }
         if(_loc13_ == null)
         {
            return null;
      ...
      override public function dispose() : void
      {
         ...
         if(var_321 != null)
         {
            ...
            {
               _loc2_ = var_321.getWithIndex(_loc1_) as LandscapePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
