package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1280:int = const_290;
      ...
      public static const const_674:int = 6;
      
      public static const const_254:int = const_97;
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1447 == const_97)
         {
            _loc5_ = new Rectangle(0,0,var_39.width,var_476);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_476,var_39.width,var_476);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_39 != null)
            {
               if(var_39.width == param2 && var_39.height == param3 && Vector3d.isEqual(var_762,param4))
               {
                  if(param1 != null)
                  {
