package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc6_:String = _loc3_.getString(RoomObjectVariableEnum.const_158);
         var _loc7_:Number = new Date().valueOf();
         var _loc8_:Boolean = false;
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_577);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_590);
         ...
         var _loc13_:Number = _loc7_ - var_1174;
         ...
         var _loc15_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_317);
         if(_loc15_ > 0)
         {
         ...
         var _loc20_:Boolean = _isAnimating || var_460 > 0;
         if(_loc19_ || _loc20_)
         {
            --var_460;
            _loc22_ = getTimer();
            ...
            if(_loc5_ == null)
            {
               _loc5_ = var_783.getAvatar(_loc6_,param1.scale);
               if(_loc5_ == null)
               {
                  return;
               }
            ...
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_295);
            ...
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_717);
            _loc5_.appendAction(AvatarAction.const_533,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            _loc28_ = _loc3_.getNumber(RoomObjectVariableEnum.const_374);
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_50)
            {
               _loc50_ = _loc3_.getNumber(RoomObjectVariableEnum.const_375);
               _loc51_ = 3;
               _loc52_ = _loc7_ - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_275,AvatarAction.const_1198[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_801);
            if(_loc29_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_838,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_985);
            if(_loc30_ > 0)
            {
               _loc53_ = _loc3_.getNumber(RoomObjectVariableEnum.const_869);
               _loc54_ = 5;
               _loc55_ = _loc7_ - _loc53_;
               if(_loc55_ < _loc54_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_798,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_536);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               ...
               {
                  _loc5_.appendAction(AvatarAction.const_811,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_865,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.appendAction(AvatarAction.const_466);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_349) > 0;
            if(_loc34_ || _loc12_)
            {
               _loc5_.appendAction(AvatarAction.const_507);
            }
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_404);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_918);
            if(_loc35_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_648,_loc35_);
            }
            ...
            _loc42_ = getSprite(const_1574);
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_834))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
               ...
               if(_loc38_ != null)
               {
                  _loc39_ = var_783.getAvatarRendererAsset(_loc38_) as BitmapDataAsset;
               }
               if(_loc39_ != null)
               {
                  _loc42_.asset = _loc39_;
            ...
            var_784.push(getTimer() - _loc22_);
            if(false)
            {
               _loc76_ = 0;
               _loc77_ = "[";
               for each(_loc78_ in var_784)
               {
                  _loc76_ += _loc78_;
                  _loc77_ += "," + _loc78_;
               }
