package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc9_:* = 0;
         var _loc11_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_977);
         if(_loc11_ > 0)
         {
            _loc16_ = getTimer() - _loc11_;
            if(_loc16_ < AvatarAction.const_887)
            {
               _loc9_ = uint(int(Math.sin(Number(_loc16_) / 0 * 0) * 255));
               _loc10_ = _loc3_.getNumber(RoomObjectVariableEnum.const_871);
               var_460 = const_1050;
            }
         }
         ...
         var _loc15_:Boolean = _isAnimating || var_460 > 0 || _loc12_;
         if(_loc14_ || _loc15_)
         {
            _loc17_ = getTimer();
            --var_460;
            ...
            _loc19_ = _loc3_.getNumber(RoomObjectVariableEnum.const_295);
            if(isNaN(_loc19_))
            {
               _loc19_ = _loc18_;
            }
            ...
            _loc21_ = _loc3_.getString(RoomObjectVariableEnum.const_717);
            _loc5_.appendAction(AvatarAction.const_533,_loc20_,_loc21_);
            _loc22_ = false;
            if(_loc20_ == "lay")
            {
            ...
            _loc23_ = _loc3_.getString(RoomObjectVariableEnum.const_374);
            if(_loc23_ != null && _loc23_ != "")
            {
               _loc37_ = _loc3_.getNumber(RoomObjectVariableEnum.const_375);
               _loc38_ = 3;
               _loc39_ = _loc7_ - _loc37_;
               if(_loc39_ < _loc38_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_275,_loc23_);
               }
            }
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_349) > 0;
            if(_loc24_)
            {
            ...
            _loc29_ = _loc5_.getSprites().length + const_1051;
            ...
            _loc30_ = getSprite(const_1574);
            if(_loc9_ > 0)
            {
               _loc28_ = null;
               _loc28_ = var_783.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset;
               if(_loc28_ != null)
               {
            ...
            var_784.push(getTimer() - _loc17_);
            if(false)
            {
               _loc55_ = 0;
               _loc56_ = "[";
               for each(_loc57_ in var_784)
               {
                  _loc55_ += _loc57_;
                  _loc56_ += "," + _loc57_;
               }
