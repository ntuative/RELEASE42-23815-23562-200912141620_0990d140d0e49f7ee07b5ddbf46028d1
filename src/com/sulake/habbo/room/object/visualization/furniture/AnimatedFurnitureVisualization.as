      ...
      override protected function updateAnimation(param1:Number) : Boolean
      {
         ...
         while(_loc4_ < _animationData.getLayerCount(param1))
         {
            ...
            if(_loc5_ == null || _loc5_.remainingFrameRepeats >= 0 && _loc7_ <= 0)
            {
               ...
               if(_loc6_ == AnimationFrame.const_809)
               {
                  _loc5_ = _animationData.getFrame(_loc4_,var_1236,var_468,param1);
               }
               else
               {
                  _loc5_ = _animationData.getFrameFromSequence(_loc4_,var_1236,_loc6_,_loc5_.activeSequenceOffset + 1,var_468,param1);
               }
