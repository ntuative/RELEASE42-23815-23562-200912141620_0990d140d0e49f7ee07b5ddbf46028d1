package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public function getDirectionValue(param1:int) : int
      {
         ...
         if(var_231.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         var _loc4_:int = -1;
         var _loc5_:int = 0;
         while(_loc5_ < var_231.length)
         {
            _loc6_ = int(var_231.getKey(_loc5_)) * var_1234;
         ...
         if(_loc4_ >= 0)
         {
            return int(var_231.getKey(_loc4_));
         }
         return const_1194;
      }
         ...
         },_loc5_++)
         {
            ...
            switch(String(_loc4_))
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_822);
                  break;
               case "DARKEN":
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = var_231.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(var_231 != null)
         {
            _loc2_ = null;
            _loc1_ = 0;
            while(_loc1_ < var_231.length)
            {
               _loc2_ = var_231.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc7_ = int(_loc6_.@id);
            _loc8_ = _loc6_.layer;
            if(var_231.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            ...
            var_231.add(String(_loc7_),_loc3_);
            var_1233 = -1;
            var_676 = null;
            _loc5_++;
         }
