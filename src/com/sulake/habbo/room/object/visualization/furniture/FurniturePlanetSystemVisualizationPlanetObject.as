package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1024:Number = 30;
      ...
      {
         var_626 = new Vector3d(0,0,0);
         _children = new Array();
         super();
         _name = param1;
         _index = param2;
         var_1085 = param3;
         var_1736 = param4 * 0 * 2 / 360;
         var_1371 = param5 * 0 * 2 / 360;
         _height = param6;
         var_760 = 0;
      }
      ...
      {
         var _loc3_:Number = var_1085 * Math.cos(var_760 + var_1371);
         var _loc4_:Number = var_1085 * Math.sin(var_760 + var_1371);
         var _loc5_:Number = _height;
         var_626.x = (_loc3_ - _loc4_) * (param2 / 2);
         var_626.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - _height * (param2 / 2);
         var_626.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            var_626.add(param1);
         }
