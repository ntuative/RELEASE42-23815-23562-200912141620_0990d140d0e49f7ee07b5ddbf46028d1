   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_105.length)
         {
            ...
            _loc8_ = var_105[_loc4_] as FurniturePlane;
            if(_loc8_ != null)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(var_105 != null)
         {
            ...
            {
               _loc2_ = var_105[_loc1_] as FurniturePlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_471);
