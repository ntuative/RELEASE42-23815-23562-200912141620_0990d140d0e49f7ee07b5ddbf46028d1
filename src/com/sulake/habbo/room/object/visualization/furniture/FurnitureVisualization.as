package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_2188:Number = NaN;
      ...
      private function updateSprites(param1:int, param2:Number) : void
      {
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc7_ != null)
            {
               _loc8_ = _loc7_.getString(RoomObjectVariableEnum.const_328);
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc6_ < spriteCount - 1)
                  {
                     ...
                     _loc10_.color = getSpriteColor(_loc6_,var_2189,param1);
                  ...
                  else
                  {
                     ...
                     {
                        _loc13_ *= object.getModel().getNumber(RoomObjectVariableEnum.const_172);
                     }
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2189 = _loc3_.getNumber(RoomObjectVariableEnum.const_210);
      ...
      protected function getSpriteAlpha(param1:int, param2:int, param3:int) : int
      {
         ...
         if(_loc5_ != null)
         {
            _loc6_ = Number(_loc5_.getNumber(RoomObjectVariableEnum.const_172));
            if(isNaN(_loc6_))
            {
               _loc6_ = 1;
            }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_278 != _loc3_.getUpdateID() || param1 != var_207 || param2 != var_2188)
         {
