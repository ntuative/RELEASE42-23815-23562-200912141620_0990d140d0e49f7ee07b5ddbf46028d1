package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         var_529.assign(param2);
         var_528 = new Vector3d();
         var_528.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_1787)
         {
            if(!param1)
            {
               var_251.assign(var_529);
               var_252.assign(var_528);
            }
            else
            {
               var_251.assign(var_529);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_80 == null && var_669 != null || var_251 == null || var_252 == null || var_386 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1142)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_953 || _loc4_.y != var_1788 || _loc4_.z != var_1786 || param1.scale != var_1790))
            {
               ...
               _loc6_ = param1.getScreenPosition(var_669);
               _loc7_ = _loc6_.z;
