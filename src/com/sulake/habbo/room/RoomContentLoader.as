package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_1026:int = 2;
      
      private static const const_335:String = "place_holder";
      
      private static const const_1025:String = const_335;
      ...
      public static const const_617:String = "RCL_LOADER_READY";
      ...
      private var var_950:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_631 = [];
         var_632 = [];
         var_1759 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1758 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_373 = new Map();
         _events = new Map();
      ...
      {
         if(var_172 != null && var_172.hasWorldType(const_271 + param1))
         {
            return var_172.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_631.indexOf(_loc14_) < 0)
                              {
                                 var_631.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              var_526.add(_loc10_,_loc11_);
                              if(var_632.indexOf(_loc14_) < 0)
                              {
                                 var_632.push(_loc14_);
                              }
                           }
                           _loc16_ = var_449.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_449.remove(_loc14_);
                              var_449.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      {
         return [const_335,const_485,ROOM_CONTENT,const_743,const_745];
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_32 || _loc2_ == RoomObjectCategoryEnum.const_29)
         {
            ...
            return int(var_449.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1759.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_171 && _loc5_ != RoomObjectLogicEnum.const_119)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_631.indexOf(param1) >= 0)
         {
            return const_335;
         }
         if(var_632.indexOf(param1) >= 0)
         {
            return const_485;
         }
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1133);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_526.getValue(param1) as String;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1758.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
      ...
      private function continueInitilization() : void
      {
         if(var_1761)
         {
            ...
            if(var_950 != null)
            {
               var_950.dispatchEvent(new Event(const_617));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_172 != null)
         {
            return var_172.getWorldHeightScale(const_271 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_950 = param1;
            var_1763 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1760 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1762 = param2.getKey("public.room.dynamic.download.url","");
            var_1757 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_744;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(var_371 != null)
         {
            var_371.remove(param2);
            var_371.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_171 && _loc5_ != RoomObjectVisualizationEnum.const_119)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = var_390.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         if(getObjectCategory(const_271 + param1) == RoomObjectCategoryEnum.const_56)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_172 = _publicRooms.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_463,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_172 != null)
         {
            return var_172.getWorldScale(const_271 + param1);
         }
         return 32;
      }
