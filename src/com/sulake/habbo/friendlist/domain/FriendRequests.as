package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      private var var_380:IFriendRequestsDeps;
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         _loc2_.state = FriendRequest.const_941;
         var_380.view.refreshRequestEntry(_loc2_);
      }
      ...
      public function refreshShading() : void
      {
         ...
         {
            _loc1_ = !_loc1_;
            var_380.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      public function getCountOfOpenRequests() : int
      {
         ...
         {
            if(_loc2_.state == FriendRequest.const_136)
            {
               _loc1_++;
            }
         }
      ...
      {
         var_480.push(param1);
         var_380.view.addRequest(param1);
      }
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         {
            if(!param1 || _loc3_.state != FriendRequest.const_136)
            {
               _loc2_.push(_loc3_);
            }
         }
         for each(_loc4_ in _loc2_)
         {
            ...
            if(false)
            {
               var_380.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         refreshShading();
