package com.sulake.habbo.friendlist
{
   ...
   public class SearchView implements ITabView, ISearchView
   {
      ...
      {
         var_699 = ITextFieldWindow(param1.findChildByName("search_str"));
         var_699.procedure = onSearchInput;
         var_699.addEventListener(WindowKeyboardEvent.const_109,onSearchStrInput);
      ...
      private function refreshShading() : void
      {
         ...
         {
            _list.getListItemAt(_loc1_).color = _friendList.laf.getRowShadingColor(FriendListTab.const_301,_loc1_ % 2 == 1);
            _loc1_++;
         }
      }
      ...
      private function onSearchStrInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_699.text = _loc6_.substring(0,_loc5_);
            }
         }
      }
