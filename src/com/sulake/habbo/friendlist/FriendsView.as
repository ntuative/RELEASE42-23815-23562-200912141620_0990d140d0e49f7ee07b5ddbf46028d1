package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_566:String = "bg";
      ...
      {
         var_1961 = initButton("open_minimail",onMinimailButtonClick,param1);
         var_1959 = initButton("open_homepage",onHomeButtonClick,param1);
         var_1958 = initButton("room_invite",onInviteButtonClick,param1);
         var_1960 = initButton("remove_friend",onRemoveButtonClick,param1);
         refreshButtons();
      }
      ...
      private function refreshFriendEntry(param1:FriendCategory, param2:Friend) : void
      {
         ...
         _loc3_.id = param2.id;
         var _loc4_:IWindow = _loc3_.findChildByName(const_566);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_230)
         {
            _loc4_ = _friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            refreshButtons();
            refreshList();
            if(param1.type == WindowMouseEvent.const_230 && _loc4_.online)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1961,isEnableMinimailButton(_loc1_));
         setEnabled(var_1959,isEnableHomeButton(_loc1_));
         setEnabled(var_1958,isEnableInviteButton(_loc1_));
         setEnabled(var_1960,isEnableRemoveButton(_loc1_));
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_566);
