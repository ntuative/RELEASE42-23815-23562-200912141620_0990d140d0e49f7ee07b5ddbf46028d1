package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1360:String = "no_reqs_info";
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_308 && _loc4_.state != FriendRequest.const_320)
            {
               _loc3_.addAcceptedRequest(_loc4_.requestId);
               _loc4_.state = FriendRequest.const_308;
      ...
      {
         var_1329 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1328 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1328.procedure = onDismissAllButtonClick;
         var_1329.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_96,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_136)
         {
         ...
         else if(param1.state == FriendRequest.const_308)
         {
         ...
         else if(param1.state == FriendRequest.const_941)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1329,_loc1_);
         setEnabled(var_1328,_loc1_);
      }
