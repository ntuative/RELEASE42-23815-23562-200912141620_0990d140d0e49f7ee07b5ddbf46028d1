package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1827:IAvatarRenderManager;
      
      private var var_1396:AvatarSearchResults;
      
      private var var_136:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_775:FriendRequests;
      
      private var var_1825:int;
      
      var var_320:FriendCategories;
      
      private var var_190:IHabboToolbar;
      
      private var var_1828:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_377:FriendListTabs;
      
      private var var_1826:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1395:OpenedToWebPopup;
      ...
      {
         var_1828 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_320 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1396 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1395 == null)
         {
            var_1395 = new OpenedToWebPopup(this);
         }
         var_1395.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_775.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_775.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_377.findTab(FriendListTab.const_96).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(var_775.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_136 = param2 as IHabboMessenger;
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_320.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_775 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_320.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_320.addCategory(new FriendCategory(FriendCategory.const_883,getText("friendlist.friends")));
         var_320.addCategory(new FriendCategory(FriendCategory.const_396,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_320.addFriend(new Friend(_loc4_));
         }
         var_377 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_320.onFriendListUpdate(param1);
      ...
      {
         var _loc2_:IAvatarImage = var_1827.createAvatarImage(param1,AvatarScaleType.const_100);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1827 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_775.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_377.findTab(FriendListTab.const_96);
      ...
      {
         var_1826 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_320.getFriendCount(param1,param2);
      }
      ...
      {
         var _loc1_:String = var_167.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_377.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      {
         return var_167.getKey(param1,param1,param2);
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1396.searchReceived(_loc2_.friends,_loc2_.others);
