package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_2082:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_380,0,0,_loc4_,var_1491,var_2082,var_2083));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2079 = int(_config.getKey("interstitial.interval","30000"));
         var_2081 = int(_config.getKey("interstitial.show.time","5000"));
         var_1492 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1270 = _loc2_.imageUrl;
         var_1491 = _loc2_.clickUrl;
         if(var_1270 != "" && var_1491 != "")
         {
            _loc3_ = var_1270;
            ...
            _loc4_ = new URLRequest(var_1270);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_394,0,0,param1.bitmapData,var_2080));
            var_697 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2083 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1492 > 0 && var_1493 >= var_1492)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_697;
         if(_loc1_ > var_2079)
         {
            ++var_1493;
      ...
      {
         var_683 = param2 as IHabboCommunicationManager;
         if(var_683 == null)
         {
            return;
         }
         _connection = var_683.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2082 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
