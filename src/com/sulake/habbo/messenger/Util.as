package com.sulake.habbo.messenger
{
   ...
   public class Util
   {
      ...
      {
         return param1.createWindow(param2,param2,HabboWindowType.const_54,HabboWindowStyle.const_39,0 | (!!param5 ? HabboWindowParam.const_64 : 0),new Rectangle(param3,param4,600,600),null) as IWindowContainer;
      }
   }
}
