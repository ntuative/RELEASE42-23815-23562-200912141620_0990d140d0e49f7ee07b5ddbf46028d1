package com.sulake.habbo.messenger
{
   ...
   public class MessengerView
   {
      ...
      private var var_742:ConversationsTabView;
      ...
      {
         return this.var_742 == null ? 7 : int(this.var_742.getTabCount());
      }
      ...
      public function openMessenger() : void
      {
         ...
         if(var_28 == null)
         {
            prepareContent();
            refresh(true);
            var_136.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MESSENGER,var_28));
         }
         else
         {
            refresh(true);
      ...
      private function sendMsg() : void
      {
         ...
         var_701.text = "";
         var_136.conversations.addMessageAndUpdateView(new Message(Message.const_682,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      {
         var_28 = IFrameWindow(var_136.getXmlWindow("main_window"));
         ...
         var_742 = new ConversationsTabView(var_136,var_28);
         var_742.refresh();
         var_701 = ITextFieldWindow(var_28.findChildByName("message_input"));
         var_701.addEventListener(WindowKeyboardEvent.const_109,onMessageInput);
         var_1107 = new ConversationView(var_136,var_28);
         var_28.scaler.setParamFlag(HabboWindowParam.const_698,false);
         var_28.scaler.setParamFlag(HabboWindowParam.const_903,true);
      }
