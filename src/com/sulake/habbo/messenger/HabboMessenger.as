package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_570:MessengerView;
      ...
      private function onRoomInvite(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_993,_loc2_.senderId,getText("messenger.invitation") + " " + _loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function startConversation(param1:int) : void
      {
         var _loc2_:Conversation = var_569.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_569.setSelected(_loc2_);
            var_570.openMessenger();
            var_570.refresh(true);
         }
      }
      ...
      private function getPageParam(param1:String) : String
      {
         ...
         if(param1 == "url.prefix")
         {
            ...
            _loc2_ = var_167.getKey("url.prefix",_loc2_);
      ...
      {
         var_569.addMessageAndUpdateView(param1);
         if(!var_570.isMessengerOpen())
         {
      ...
      {
         var_569 = new Conversations(new ConversationsDeps(this));
         var_570 = new MessengerView(this);
      ...
      {
         var_569.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_165,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.MESSENGER));
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_541,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         var_569.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_844,_loc2_.userId,getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         var_569.addMessageAndUpdateView(_loc3_);
      }
