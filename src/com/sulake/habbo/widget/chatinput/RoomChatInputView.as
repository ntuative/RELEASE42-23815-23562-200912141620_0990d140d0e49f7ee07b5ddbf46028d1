package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1377:int = 5;
      
      private static const const_480:int = 16;
      ...
      private var var_413:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_1866 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1867 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_648 = new Timer(1000,1);
         var_648.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_781 = new Timer(5000,1);
         var_781.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _loc4_.addEventListener(WindowKeyboardEvent.const_109,windowKeyEventProcessor);
         _loc4_.addEventListener(WindowEvent.const_43,onInputFieldResized);
         _loc4_.addEventListener(WindowEvent.const_204,onInputChanged);
         _window.addEventListener(WindowEvent.const_373,onWindowMoved);
         var_1173 = true;
         var_137 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1868 = _loc2_.width + const_480 + _loc6_.width + const_1049;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1048,_loc8_.width) + const_480);
            _loc8_.x = _loc12_;
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_413);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_413);
         }
