package com.sulake.habbo.widget.memenu
{
   ...
   public class ClubPromoView
   {
      ...
      public static const const_403:String = "CPV_MODE_TRIAL";
      
      public static const const_1345:String = "CPV_MODE_FULL";
      ...
      private const const_1066:String = "avatareditor_club_promo_image";
      ...
      public function ClubPromoView(param1:MeMenuWidget, param2:String = "", param3:String = "CPV_MODE_FULL")
      {
         ...
         if(!setPromoImage() && param2 != "")
         {
            ...
            _loc8_ = _widget.assets.loadAssetFromFile(const_1066,_loc7_,"image/png");
      ...
      private function setPromoImage() : Boolean
      {
         ...
         if(_widget.assets.hasAsset(const_1066))
         {
            _loc2_ = _widget.assets.getAssetByName(const_1066) as BitmapDataAsset;
      ...
      private function onRedeem(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = new RoomWidgetRedeemClubPromoMessage(RoomWidgetRedeemClubPromoMessage.const_524,_loc2_.text,var_623 == const_403);
