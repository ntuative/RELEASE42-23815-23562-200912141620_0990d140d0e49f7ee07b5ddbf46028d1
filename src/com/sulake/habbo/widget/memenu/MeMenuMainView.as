package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuMainView implements IMeMenuView
   {
      ...
      public function setIconAssets(param1:String, param2:String, param3:String = null, param4:String = null) : void
      {
         ...
         if(param3 != null)
         {
            var_161[param1][0] = param3;
         }
         if(param4 != null)
         {
            var_161[param1][1] = param4;
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         _window.name = param1;
         for(_loc3_ in var_161)
         {
            _loc6_ = var_161[_loc3_];
      ...
      {
         var_161 = new Dictionary();
         var_161["rooms_icon"] = ["gohome_white","gohome_color"];
         var_161["dance_icon"] = ["dance_white","dance_color"];
         var_161["clothes_icon"] = ["clothes_white","clothes_color"];
         var_161["effects_icon"] = ["effects_white","effects_color"];
         var_161["badges_icon"] = ["badges_white","badges_color"];
         var_161["wave_icon"] = ["wave_white","wave_color"];
         var_161["hc_icon"] = ["_white","_color"];
         var_161["settings_icon"] = ["settings_white","settings_color"];
         var_161["credits_icon"] = ["credits_white","credits_color"];
         var_161["news_icon"] = ["news_white","news_color"];
         _widget = param1;
         createWindow(param2);
      }
      ...
      private function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            ...
            case "wave":
               ...
               if(false)
               {
                  _widget.messageListener.processWidgetMessage(new RoomWidgetDanceMessage(RoomWidgetDanceMessage.const_961));
            ...
            case "rooms":
               ...
               break;
            case "badges":
               _widget.messageListener.processWidgetMessage(new RoomWidgetOpenInventoryMessage(RoomWidgetOpenInventoryMessage.const_848));
               _widget.hide();
               break;
            case "clothes":
               _widget.changeView(MeMenuWidget.const_233);
               break;
            case "hc":
               ...
               break;
            case "settings":
               _widget.changeView(MeMenuWidget.const_506);
               break;
            case "news":
               if(false && false)
               {
