package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsViewSlider
   {
      ...
      private var var_825:MeMenuSettingsView;
      
      private var var_2268:int;
      
      private var var_524:BitmapData;
      
      private var var_945:Number = 1;
      ...
      private function buttonProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_825.saveVolume(getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && var_524 != null)
            {
               ...
               var_1376 = _loc1_.width - _loc2_.width;
            }
         }
      }
      ...
      {
         return int(var_1376 * (Number(param1 - var_628) / (var_945 - var_628)));
      }
      ...
      {
         return param1 / var_1376 * (var_945 - var_628) + var_628;
      }
   }
}
