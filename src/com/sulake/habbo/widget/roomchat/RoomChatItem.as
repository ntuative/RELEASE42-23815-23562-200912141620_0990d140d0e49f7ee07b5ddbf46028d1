package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_480:int = 6;
      
      private static const const_333:int = 10;
      
      private static const const_1008:Number = 18;
      ...
      {
         _widget.onItemMouseOut(var_908,var_909,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_908,var_909,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1088 = param1.chatType;
         var_908 = param1.userId;
         var_732 = param1.userName;
         var_909 = param1.userCategory;
         _message = param1.text;
         var_1089 = param1.userX;
         var_189 = param1.userImage;
         var_907 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1088)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_116:
               ...
               break;
            case RoomWidgetChatUpdateEvent.const_93:
               _loc1_ = "bubble_shout";
               break;
         ...
         if(var_189 != null && !_loc2_)
         {
            ...
            if(_loc28_ != null)
            {
               ...
               _loc28_.x = _loc26_;
               _loc28_.y = _loc27_;
               var_363 = Math.max(0,(0 - _loc5_.height) / 2);
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_907 != 0)
            {
               _loc31_ = uint(var_907 >> 16 & 255);
               _loc32_ = uint(var_907 >> 8 & 255);
               _loc33_ = uint(var_907 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1088 == RoomWidgetChatUpdateEvent.const_258)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_732);
            }
            else if(var_1088 == RoomWidgetChatUpdateEvent.const_266)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_732);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_363;
            _loc20_.width = _loc20_.textWidth + const_480;
            _width += _loc20_.textWidth + const_480;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_333 + _loc20_.textWidth + const_480;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_908,var_909,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_908,var_909,_roomId,_roomCategory,param1);
      }
