package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1072:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_160.state = RoomChatHistoryPulldown.const_213;
         ...
         var_50 = param2.createWindow("chatscroller","",HabboWindowType.const_952,HabboWindowStyle.const_40,0 | 0,new Rectangle(param3.rectangle.right - const_479,param3.y,const_479,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_230 > 0 && param2)
         {
            if(var_1225)
            {
               if(Math.abs(param1 - var_230) <= const_856)
               {
                  return;
               }
               var_1225 = false;
            ...
            if(var_296)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_50.scrollV < 1 - const_1072 / var_50.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1435)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_296 && !var_1286)
         {
            ...
            var_160.state = RoomChatHistoryPulldown.const_310;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_160.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_213);
      }
