package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements ICoreUpdateReceiver
   {
      ...
      private static const const_1012:int = 6000;
      
      private static const const_1014:int = 9;
      
      private static const const_740:int = 4000;
      
      private static const const_1015:int = 3;
      
      private static const const_91:int = 18;
      
      private static const const_1011:int = 25;
      ...
      private static const const_481:int = (const_482 + const_334) * const_91 + const_91;
      ...
      public function RoomChatWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:int, param6:Component)
      {
         ...
         var_215 = new Array();
         var_612 = new Point();
         var_154 = const_481 + const_270;
         super(param1,param2,param3);
         var_1709 = param5;
         var_43 = param1.createWindow("chat_container","",HabboWindowType.const_54,HabboWindowStyle.const_39,HabboWindowParam.const_35,new Rectangle(0,0,200,var_154 + RoomChatHistoryPulldown.const_69),null,0) as IWindowContainer;
         var_43.background = true;
         var_43.color = 33554431;
         var_43.tags.push("room_widget_chat");
         var_326 = param1.createWindow("chat_contentlist","",HabboWindowType.const_810,HabboWindowStyle.const_40,0 | 0 | 0,new Rectangle(0,0,200,var_154),null,0) as IItemListWindow;
         var_43.addChild(var_326);
         var_127 = param1.createWindow("chat_active_content","",HabboWindowType.const_54,HabboWindowStyle.const_40,HabboWindowParam.const_64,new Rectangle(0,0,200,var_154),null,0) as IWindowContainer;
         var_326.addListItem(var_127);
         var_37 = new RoomChatHistoryViewer(this,param1,var_43,param2);
         var_1710 = int(param4.getKey("chat.history.item.max.count","150"));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChatUpdateEvent.const_503,onChatMessage);
         ...
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_658,onRoomViewUpdate);
      ...
      public function resetArea() : void
      {
         ...
         animationStop();
         var_154 = const_481 + const_270;
         var_43.height = var_154 + var_37.pulldownBarHeight;
         var_326.width = 0 - 0;
         var_326.height = var_154;
         var_127.width = 0 - 0;
      ...
      private function processBuffer() : void
      {
         ...
         while(var_69.length > const_1013 || historyViewerActive() && false)
         {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + var_612.x) * var_751;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = 0 - const_739;
         var _loc6_:Number = 0 + const_739 - 0;
      ...
      public function mouseUp() : void
      {
         ...
         if(var_1122 && !historyViewerActive())
         {
            resetArea();
            var_1122 = false;
         }
      ...
      {
         return "chat_" + var_1709.toString() + "_item_" + (var_1711++).toString();
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChatUpdateEvent.const_503,onChatMessage);
         ...
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_658,onRoomViewUpdate);
      }
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            _loc3_ = !!historyViewerActive() ? 0 : Number(var_436);
            if(_loc2_ == -1)
            {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(_isAnimating)
         {
            _loc2_ = param1 / const_1011 * const_1015;
            if(_loc2_ + var_611 > var_520)
            {
               _loc2_ = var_520 - var_611;
            }
            if(_loc2_ > 0)
            {
               moveItemsUp(_loc2_);
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(var_1355 == 0)
            {
               var_1355 = param1.scale;
            }
            else
            {
               var_751 = param1.scale / var_1355;
            }
         }
         if(param1.positionDelta != null)
         {
            var_612.x += param1.positionDelta.x / var_751;
            var_612.y += param1.positionDelta.y / var_751;
         }
         if(param1.rect != null)
         {
            if(var_37 == null)
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(_itemList.length > var_1710)
         {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(false)
               {
                  ...
                  {
                     _loc1_.screenLevel = _loc3_ + Math.max(var_436,1);
                  }
               }
               else
               {
      ...
      public function stretchAreaBottomTo(param1:Number) : void
      {
         ...
         var_154 = param1 - 0;
         var_43.height = var_154 + RoomChatHistoryPulldown.const_69;
         if(var_37 != null)
         {
            var_37.containerResized(var_43.rectangle);
         }
      ...
      public function onItemMouseClick(param1:int, param2:int, param3:int, param4:int, param5:WindowMouseEvent) : void
      {
         ...
         var _loc6_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_319,param1,param2);
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_334 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timestamp >= const_1012)
               {
