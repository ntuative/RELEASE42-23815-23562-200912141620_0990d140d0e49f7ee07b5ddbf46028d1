package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_748:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_43 = param3;
         var_1840 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1397 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_1838 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1399 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1398 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_1843 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_1841 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_77 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_39,HabboWindowParam.const_64,new Rectangle(0,0,param3.width,param3.height - const_69),null,0,0) as IBitmapWrapperWindow;
         var_43.addChild(var_77);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_54,HabboWindowStyle.const_39,HabboWindowParam.const_35,new Rectangle(0,0 - const_69,param3.width,const_69),null,0) as IWindowContainer;
         var_43.addChild(_window);
         var_102 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_354,HabboWindowStyle.const_40,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_69),null,0) as IRegionWindow;
         if(var_102 != null)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_366:
               var_77.blend += param1 / const_748;
               _window.blend += param1 / const_748;
               if(false)
               {
                  state = const_310;
               }
               break;
            case const_753:
               var_77.blend = 0 - param1 / const_749;
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_1842 == _window.width)
         {
            return;
         }
         var_1842 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_1840.clone(),_loc7_);
