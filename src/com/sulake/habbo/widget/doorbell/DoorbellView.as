package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellView
   {
      ...
      public function createMainWindow() : void
      {
         ...
         var _loc1_:XmlAsset = var_332.assets.getAssetByName("doorbell") as XmlAsset;
         var_58 = (var_332.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(var_58 == null)
         {
      ...
      {
         var _loc6_:* = null;
         var _loc3_:XmlAsset = var_332.assets.getAssetByName("doorbell_list_entry") as XmlAsset;
         var _loc4_:IWindowContainer = var_332.windowManager.buildFromXML(_loc3_.content as XML) as IWindowContainer;
         if(_loc4_ == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function update() : void
      {
         ...
         if(_list != null)
         {
            ...
            _loc1_ = 0;
            while(_loc1_ < var_332.users.length)
            {
               _list.addListItem(createListItem(var_332.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
