package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetInterstitialUpdateEvent.const_83,onShowInterstitial);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_83,onShowLoadingBar);
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1478 != "")
         {
            HabboWebTools.openWebPage(var_1478);
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetInterstitialUpdateEvent.const_83,onShowInterstitial);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_83,onShowLoadingBar);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_83)
         {
            return;
         }
         if(!createWindow())
