package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1006:Number = 100;
      
      private static const const_1057:int = 500;
      
      private static const const_1007:Number = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_497,onObjectUpdate);
      ...
      private function sendSetColor(param1:uint) : void
      {
         ...
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_453,var_155,var_191,var_657);
      ...
      private function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_652,var_155);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_497,onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         var_1417 = param1.objectType;
         var_191 = param1.text;
         var_657 = param1.colorHex;
      ...
      private function sendUpdate() : void
      {
         ...
         if(messageListener != null)
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_453,var_155,var_191,var_657);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function showInterface() : void
      {
         ...
         if(_window == null)
         {
            _window = windowManager.createWindow("stickieui_container","",HabboWindowType.const_54,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1007,const_1006,2,2),null,0) as IWindowContainer;
         ...
         {
            _loc3_.text = var_191;
            _loc3_.addEventListener(WindowEvent.const_204,onTextWindowEvent);
         }
         _loc6_ = _window.findChildByTag("bg") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
            if(var_1417 == "post_it_vd")
            {
            ...
            else
            {
               ...
               _loc6_.color = uint("0xFF" + var_657);
            }
         ...
         setColorButtons(_controller && var_1417 == "post_it");
      }
