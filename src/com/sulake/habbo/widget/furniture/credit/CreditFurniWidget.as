package com.sulake.habbo.widget.furniture.credit
{
   ...
   public class CreditFurniWidget extends RoomWidgetBase
   {
      ...
      private function sendRedeemMessage() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetCreditFurniRedeemMessage(RoomWidgetCreditFurniRedeemMessage.const_627,var_798);
      ...
      private function showInterface() : void
      {
         ...
         windowManager.registerLocalizationParameter("widgets.furniture.credit.redeem.value","value",String(var_1201));
         ...
         _window = windowManager.createWindow("creditfurniui_container","",HabboWindowType.const_54,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1007,const_1006,2,2),null,0) as IWindowContainer;
