package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_54,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1007,const_1006,2,2),null,0) as IWindowContainer;
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_985 = _loc2_.light;
         if(var_334 != null)
         {
            var_334.setValue(var_985);
         }
         var_375 = colors.indexOf(_loc2_.color);
         if(var_467 != null)
         {
            var_467.setSelectedColorIndex(var_375);
         }
