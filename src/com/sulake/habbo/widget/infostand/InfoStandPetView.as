package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1593:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1591:String = "level";
      
      private var var_110:IItemListWindow;
      
      private const const_1590:String = "energy";
      
      private var var_1256:Map;
      
      private const const_1586:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1587:uint = 3355443;
      
      private var var_223:IBorderWindow;
      
      private const const_1589:int = 158;
      
      private const const_1588:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_274:PetCommandTool;
      
      private const const_1585:uint = 11184810;
      
      private const const_1592:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_223 != null)
         {
            var_110 = var_223.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_110 == null || var_223 == null || var_65 == null)
         {
            return;
         }
         ...
         var_223.height = NaN;
         _window.width = Math.max(var_223.width,var_65.width);
      ...
      private function openTrainView() : void
      {
         if(var_274 == null)
         {
            var_274 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1256.getValue(var_672) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_274.showWindow(true);
            var_274.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1591,param1.level,param1.levelMax);
         updateStateElement(const_1592,param1.experience,param1.experienceMax);
         updateStateElement(const_1590,param1.energy,param1.energyMax);
         updateStateElement(const_1586,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_672 = param1.id;
         var_1256.remove(param1.id);
         var_1256.add(param1.id,param1);
         if(var_274 && var_274.isVisible() && param1.isOwnPet)
         {
            var_274.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_274.setEnabledCommands(param1,param2);
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_437,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1589,const_1588,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1585);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1587);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1593);
         return _loc5_;
      }
