package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private var var_1256:InfoStandPetData;
      
      private var var_144:Timer;
      
      private var var_837:InfoStandFurniView;
      
      private var var_367:InfostandFurniData;
      
      private var var_344:InfoStandBotView;
      
      private var _mainContainer:IWindowContainer;
      
      private const const_1386:String = "infostand_bot_view";
      
      private var _config:IHabboConfigurationManager;
      
      private const const_1385:String = "infostand_pet_view";
      
      private const const_1383:String = "infostand_furni_view";
      
      private const const_1583:int = 3000;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_837 = new InfoStandFurniView(this,const_1383);
         var_202 = new InfoStandUserView(this,const_1384);
         var_300 = new InfoStandPetView(this,const_1385);
         var_344 = new InfoStandBotView(this,const_1386);
         var_379 = new InfostandUserData();
         var_367 = new InfostandFurniData();
         var_1256 = new InfoStandPetData();
         var_144 = new Timer(const_1583);
         var_144.addEventListener(TimerEvent.TIMER,onUpdateTimer);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_202.setTags(param1.tags,var_2040);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_245,onRoomObjectRemoved);
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_499,onFurniInfo);
         param1.addEventListener(RoomWidgetUserTagsUpdateEvent.const_132,onUserTags);
         param1.addEventListener(RoomWidgetUserFigureUpdateEvent.const_130,onUserFigureUpdate);
         param1.addEventListener(RoomWidgetUserBadgesUpdateEvent.const_125,onUserBadges);
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_571,onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_392,var_300.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_245,onRoomObjectRemoved);
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_499,onFurniInfo);
         param1.removeEventListener(RoomWidgetUserTagsUpdateEvent.const_132,onUserTags);
         param1.removeEventListener(RoomWidgetUserFigureUpdateEvent.const_130,onUserFigureUpdate);
         param1.removeEventListener(RoomWidgetUserBadgesUpdateEvent.const_125,onUserBadges);
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_571,onBadgeImage);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectUpdateEvent.const_122:
               _loc2_ = param1.id == var_367.id;
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_245:
               ...
               {
                  _loc2_ = param1.id == var_1256.roomIndex;
                  break;
               }
