package com.sulake.habbo.configuration
{
   ...
   public class HabboConfigurationManager extends Component implements IHabboConfigurationManager
   {
      ...
      {
         (_context as CoreComponent).error("Could not load external variables. Client startup failed!",true,CoreComponent.const_1286);
      }
      
      public function keyExists(param1:String) : Boolean
      {
         var _loc2_:String = var_931[param1] as String;
         return _loc2_ != null;
      }
      ...
      public function setKey(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         if(var_1362.indexOf(param1) < 0)
         {
            var_931[param1] = param2;
         }
      }
      ...
      {
         var _loc4_:String = var_931[param1] as String;
         if(_loc4_ == null)
         {
            _loc4_ = param2;
         }
         if(_loc4_ != null)
         {
            ...
            {
               _loc4_ = _loc4_.replace("%predefined%",var_1722);
