package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         {
            var_720 = getBitmapDataFromAsset(param1.background,param2);
         }
      ...
      {
         if(var_1071 == true || var_596 == 0)
         {
            if(false)
            {
               ++var_58;
               if(var_58 >= var_721.length)
               {
                  var_58 = 0;
                  ++var_596;
               }
      ...
      {
         return var_1071 == false && var_596 == 1 && var_1183 != _state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_720 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_720.width),Math.max(param2.height,var_720.height));
            _loc3_.copyPixels(var_720,var_720.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_58 <= var_722.length)
         {
            _loc2_ = var_722[var_58];
