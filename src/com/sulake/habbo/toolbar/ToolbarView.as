package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_196 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_54,HabboWindowStyle.const_849,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_976 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_976)
         {
         ...
         var_1208 = _loc7_.toolbar.@margin_bottom;
         var_1415 = _loc7_.toolbar.@min_group_margin;
         var_1416 = _loc7_.toolbar.@margin_to_extrabar;
         var_271 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_261,param1,param2,_window,var_271);
         createGroupsFromXmlList(_loc9_,var_542,param1,param2,var_196,var_271);
         method_1();
      }
      ...
      public function dispose() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_261.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(false)
         {
            _loc1_ = var_542.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(_window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_141,var_464,param3);
         }
      }
      ...
      private function method_1() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1415,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1208) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1415,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1208) / -1));
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_141,var_464);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < var_542.length)
         {
            _loc2_ = var_542[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_141,var_464);
         }
      }
