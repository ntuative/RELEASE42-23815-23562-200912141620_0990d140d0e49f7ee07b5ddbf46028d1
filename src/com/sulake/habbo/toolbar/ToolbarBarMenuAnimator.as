package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1011:Number = 25;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_954 = param2;
         var_530 = new Timer(const_1011);
         var_530.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_282.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_282.splice(var_282.indexOf(param1),1);
            }
         }
      }
      ...
      {
         return var_453[var_452.indexOf(param1)];
      }
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_282[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_531[_loc3_] = new Array();
            }
            if(var_531[_loc3_].indexOf(param1) < 0)
            {
               var_531[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_746 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_746 || param1.desktop.height - param1.y < const_1030;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < var_453.length)
         {
            if(var_453[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_531[_loc3_].length)
                  {
                     repositionWindow(var_531[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
