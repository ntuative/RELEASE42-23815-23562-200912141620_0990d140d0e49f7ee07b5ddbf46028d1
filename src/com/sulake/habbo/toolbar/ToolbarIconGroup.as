package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return var_1154.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1152.length)
         {
            _loc2_ = var_640.indexOf(var_1152[_loc4_]);
            if(_loc2_ > -1)
            {
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_285[var_640.indexOf(param1)];
      }
