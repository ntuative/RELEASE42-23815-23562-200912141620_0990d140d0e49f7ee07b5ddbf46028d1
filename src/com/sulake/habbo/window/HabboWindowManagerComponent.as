package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private var var_1177:ProfilerAgentTask;
      
      private var var_1180:IEventDispatcher;
      
      private var var_2273:uint = 0;
      
      private var var_1179:ProfilerAgentTask;
      
      private var var_1178:ProfilerOutput;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(param1 is CoreComponent)
         {
            ...
            _instance = this;
            var_1180 = Component(param1).events;
            var_788 = new Array();
      ...
      {
         return var_287[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_287[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_287 = new Array(const_336);
         var _loc6_:int = 0;
         while(_loc6_ < const_336)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_651,this,_localization,var_187,new Rectangle(0,0,var_187.stageWidth,var_187.stageHeight),this);
            var_287[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_360 = var_287[const_1053];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_360.getMouseCursor().defineCustomCursorType(MouseCursorType.const_284,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_360.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1343,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_287[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_287.pop()).dispose();
            }
            if(var_1178 != null)
            {
               var_1178.dispose();
      ...
      {
         return var_287[param1].getDesktopWindow().getChildAt(var_360.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1178 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1178 = new ProfilerOutput(_loc3_,this,var_651);
               var_1177 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1177);
               var_1179 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1179);
               var_970 = true;
            }
         }
      }
      ...
      {
         return var_360.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_863.length > 0)
         {
            var_1180.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_336 - 1;
            while(_loc2_ >= 0)
            {
               var_287[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_970)
         ...
         var_1180.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_336)
         {
            var_287[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_970)
         {
         ...
         if(WindowContext.var_863.length > 0)
         {
            WindowContext.var_863.flush();
         }
         if(WindowContext.var_1290.length > 0)
         {
            WindowContext.var_1290.flush();
         }
         var_1180.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_788[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_788[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_360.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1219,param2.name + ": " + param2.toString());
            }
         }
      }
   }
