package com.sulake.habbo.window.utils
{
   ...
   public class Logger extends Component implements ILogger
   {
      ...
      private var var_1310:ICoreWindowManager;
      ...
      {
         var_1310 = param2 as ICoreWindowManager;
         _window = var_1310.create("Logger::Output",HabboWindowType.const_285,WindowStyle.const_269,0 | 0 | 0 | 0,new Rectangle(0,0,180,240),loggerEventProc,"Logger") as IFrameWindow;
         var_313 = var_1310.create("Logger::Output::Text",HabboWindowType.const_1188,WindowStyle.const_269,0 | 0 | 0,new Rectangle(0,0,_window.content.width,_window.content.height),null,"") as ITextWindow;
