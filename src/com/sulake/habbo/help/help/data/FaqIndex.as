package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         var_694 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_695 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_146 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_694.hasItem(param1))
         {
            var_694.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_695.hasItem(param1))
         {
            var_695.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
