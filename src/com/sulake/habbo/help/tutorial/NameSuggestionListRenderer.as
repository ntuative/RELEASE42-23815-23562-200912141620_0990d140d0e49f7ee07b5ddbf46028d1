package com.sulake.habbo.help.tutorial
{
   ...
   public class NameSuggestionListRenderer
   {
      ...
      private const const_1577:int = 5;
      ...
      {
         var _loc2_:ITextWindow = var_57.buildXmlWindow("tutorial_name_suggestion_item") as ITextWindow;
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      private function fit(param1:Rectangle) : Boolean
      {
         ...
         if(var_827 + param1.height > _rect.height)
         {
            return false;
         }
         ...
         {
            _offsetX = 0;
            var_827 += param1.height + const_1578;
            return fit(param1);
         }
         param1.offset(_offsetX,var_827);
         _offsetX += param1.width + const_1577;
         return true;
      }
