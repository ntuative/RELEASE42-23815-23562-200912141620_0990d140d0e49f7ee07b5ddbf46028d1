package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         var_57.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_47,onShowMenuEvent);
      ...
      public function setToolbarIconHighlight(param1:Boolean) : void
      {
         ...
         var_57.help.toolbar.events.dispatchEvent(_loc2_);
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_47)
         {
            ...
            hideToolbarIconHighlightArrow();
            var_57.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_376));
         }
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         var_519 = var_57.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = var_519.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
            _loc2_ = BitmapDataAsset(var_57.assets.getAssetByName("tutorial_highlight_blue_arrow"));
            _loc1_.bitmap = (_loc2_.content as BitmapData).clone();
         }
         var_57.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.MEMENU_ARROW,var_519));
      }
      
      public function dispose() : void
      {
         setToolbarIconHighlight(false);
         var_57.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_47,onShowMenuEvent);
      }
   }
}
