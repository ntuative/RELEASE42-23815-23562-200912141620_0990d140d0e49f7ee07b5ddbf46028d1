package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialMainView implements ITutorialUIView
   {
      ...
      private function setButtonStateOver(param1:IWindow) : void
      {
         ...
         {
            case "button_name":
               _loc3_ = BitmapDataAsset(var_57.assets.getAssetByName("tutorial_button_changename_over"));
               break;
            case "button_looks":
               _loc3_ = BitmapDataAsset(var_57.assets.getAssetByName("tutorial_button_changelooks_over"));
               break;
            case "button_guidebot":
               _loc3_ = BitmapDataAsset(var_57.assets.getAssetByName("tutorial_button_guidebot_over"));
         }
      ...
      private function setButtonStateNormal(param1:IWindow) : void
      {
         ...
         {
            case "button_name":
               _loc3_ = BitmapDataAsset(var_57.assets.getAssetByName("tutorial_button_changename"));
               break;
            case "button_looks":
               _loc3_ = BitmapDataAsset(var_57.assets.getAssetByName("tutorial_button_changelooks"));
               break;
            case "button_guidebot":
               _loc3_ = BitmapDataAsset(var_57.assets.getAssetByName("tutorial_button_guidebot"));
         }
         if(_loc2_ != null && _loc3_ != null && _loc3_.content != null)
         {
            _loc2_.bitmap = (_loc3_.content as BitmapData).clone();
      ...
      private function windowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param2.name)
         {
            case "button_looks":
               switch(param1.type)
               {
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
                     var_57.showView(TutorialUI.const_291);
                     break;
            ...
            case "button_name":
               ...
               {
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
                     var_57.showView(TutorialUI.const_221);
                     break;
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                     setButtonStateOver(param2);
                     break;
            ...
            case "button_guidebot":
               ...
               {
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
                     var_57.showView(TutorialUI.const_421);
                     break;
                  case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
                     setButtonStateOver(param2);
                     break;
