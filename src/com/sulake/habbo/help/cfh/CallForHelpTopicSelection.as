package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTopicSelection extends HelpViewController implements IHelpViewController
   {
      ...
      private function handleListItemClick(param1:IWindow) : void
      {
         ...
         if(var_698 == null || _loc3_ < 0 || _loc3_ >= var_698.length)
         {
            return;
         }
         if(_loc3_ > -1)
         {
            main.component.callForHelpData.topicIndex = var_698[_loc3_];
            main.showUI(HabboHelpViewEnum.const_567);
            main.tellUI(HabboHelpViewEnum.const_567,null);
         }
      }
   }
}
