package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private function selectFirst() : void
      {
         ...
         setSelectedGridItem(var_556.getWithIndex(0));
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_51)
         {
            ...
            {
               case "tab_floor":
                  var_88.switchCategory(FurniModel.const_41);
                  break;
               case "tab_wall":
                  var_88.switchCategory(FurniModel.const_42);
            }
            selectPetsTab();
         }
      }
      ...
      {
         var_88.placePetToRoom(param1,param2);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = var_556.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_556.getValue(param1.id) != null)
         {
            return;
         }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(false)
         {
            _loc8_ = var_88.roomSession.arePetsAllowed;
            _loc9_ = var_88.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
