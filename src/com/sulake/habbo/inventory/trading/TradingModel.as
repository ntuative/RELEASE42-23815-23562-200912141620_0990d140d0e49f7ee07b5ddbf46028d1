package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_53.updateItemList(var_1095);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_53.alertPopup(TradingView.const_989);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               var_433 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
      ...
      {
         Logger.log("OLD STATE: " + _state + " NEW STATE: " + param1 + " OWN: " + var_433 + " OTHER: " + var_601);
         ...
         {
            case const_169:
               if(param1 == const_151 || param1 == const_202)
               {
                  _state = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_53.setMinimized(param1 != InventoryCategory.const_70);
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         else
         {
            ...
            if(param3 == FurniCategory.const_156)
            {
      ...
      public function close() : void
      {
         if(var_564)
         {
            if(_state != const_169 && _state != const_202)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_169;
            var_25.toggleInventorySubPage(InventorySubCategory.const_779);
            var_564 = false;
         }
         var_53.setMinimized(false);
      }
