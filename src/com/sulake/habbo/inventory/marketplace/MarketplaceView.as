package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceView implements IGetImageListener
   {
      ...
      private var var_88:MarketplaceModel;
      ...
      public function showMakeOffer(param1:IItem) : void
      {
         ...
         checkPrice();
         _localization.registerParameter("inventory.marketplace.make_offer.expiration_info","time",var_88.expirationHours.toString());
         _localization.registerParameter("inventory.marketplace.make_offer.min_price","minprice",var_88.offerMinPrice.toString());
         _localization.registerParameter("inventory.marketplace.make_offer.max_price","maxprice",var_88.offerMaxPrice.toString());
         ...
         var_1653 = _localization.getKey("roomItem.name." + param1.type);
      ...
      {
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","furniname",var_1653);
         _localization.registerParameter("inventory.marketplace.confirm_offer.info","price",var_1341.toString());
      ...
      private function checkPrice() : void
      {
         ...
         if(_loc2_ > var_88.offerMaxPrice)
         {
            _loc1_.text = var_88.offerMaxPrice.toString();
            _loc2_ = 0;
         }
         ...
         if(_loc2_ < var_88.offerMinPrice)
         {
