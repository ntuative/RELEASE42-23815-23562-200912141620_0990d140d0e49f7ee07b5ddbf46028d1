package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1569:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_33 != null)
         {
            var_33.events.removeEventListener(RoomSessionEvent.const_85,roomSessionEventHandler);
            var_33.events.removeEventListener(RoomSessionEvent.const_101,roomSessionEventHandler);
            var_33.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_352,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_101:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_352:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_52.getValue(InventoryCategory.const_707));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_52.getValue(InventoryCategory.const_70));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_783));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_52.getValue(InventoryCategory.const_155));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1569);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_52.getValue(InventoryCategory.const_287));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_731.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_731.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         return TradingModel(var_52.getValue(InventorySubCategory.const_222));
      }
      ...
      {
         return var_52.getValue(InventoryCategory.const_431) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1337 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_52.getValue(InventoryCategory.const_246));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_33.events.addEventListener(RoomSessionEvent.const_85,roomSessionEventHandler);
         var_33.events.addEventListener(RoomSessionEvent.const_101,roomSessionEventHandler);
         var_33.events.addEventListener(RoomSessionPropertyUpdateEvent.const_352,roomSessionEventHandler);
         ...
         var_52.add(InventoryCategory.const_431,_loc3_);
         ...
         var_52.add(InventoryCategory.const_155,_loc10_);
