package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_979:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_97 = var_543.height;
         var_980 = param5;
         var_809 = param6;
         var_228 = Math.floor(var_980 / _thumbWidth);
         var_31 = new BitmapData(var_980,var_809);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_31.height < var_809)
         {
            _loc12_ = new BitmapData(var_31.width,var_809);
      ...
      private function getList() : Array
      {
         ...
         if(var_979 != null)
         {
            _loc1_ = var_979.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_31 = new BitmapData(Math.max(var_228 * _thumbWidth,var_980),Math.max(var_466 * var_97,var_809),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_228 && var_31.height < _loc3_.y * var_97)
         {
         ...
         _loc4_ = new Rectangle(_thumbWidth * (var_228 - 1),0,_thumbWidth,var_31.height);
