package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private var var_944:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboConfigurationManager)
      {
         ...
         _roomEngine = param5;
         var_446 = new Map();
         var_446.add(FurniModel.const_41,new FurniGridView(var_88,FurniModel.const_41,_windowManager,_assetLibrary,_roomEngine));
         var_446.add(FurniModel.const_42,new FurniGridView(var_88,FurniModel.const_42,_windowManager,_assetLibrary,_roomEngine));
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "placeinroom_btn":
                  var_88.requestSelectedFurniPlacement(false);
                  break;
               case "offertotrade_btn":
                  var_88.requestSelectedFurniToTrading();
                  break;
               case "sell_btn":
                  var_88.requestSelectedFurniSelling();
                  break;
               default:
                  var_88.cancelFurniInMover();
            }
         }
         else if(param1.type == WindowEvent.const_51)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  switchCategory(FurniModel.const_280);
            }
         }
      }
      ...
      {
         var _loc3_:GroupItem = var_88.getGroupItemInIndex(var_88.getSelectedItemIndex());
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         var_88.furniCategorySwitch(param1);
      }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:int = var_88.getSelectedItemIndex();
         _loc4_ = var_88.getGroupItemInIndex(_loc3_,var_445);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            if(_loc5_.category == FurniCategory.const_296)
            {
            ...
            {
               if(_loc5_.category == FurniCategory.const_156)
               {
         ...
         if(_loc12_)
         {
            if(_loc1_ && _loc4_ != null && _loc5_ != null && var_88.canUserOfferToTrade())
            {
         ...
         if(_loc12_)
         {
            if(_loc1_ && var_944 && false && _loc5_.sellable)
            {
               _loc12_.enable();
            }
            else
