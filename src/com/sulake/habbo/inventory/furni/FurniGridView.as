package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      {
         var _loc3_:* = null;
         var _loc1_:Array = var_88.getCategoryContent(_category);
         var _loc2_:int = 0;
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_53)
         {
            ...
            var_88.toggleItemSelection(_category,var_451.getGridItemIndex(param1.window));
            var_331 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_28 && var_331 != null && var_331 == param2 && true)
         {
            _loc3_ = var_88.requestSelectedFurniPlacement(true);
            if(_loc3_)
            {
               var_331 = null;
            }
         ...
         {
            var_88.requestCurrentActionOnSelection();
            var_331 = null;
         }
      }
   }
