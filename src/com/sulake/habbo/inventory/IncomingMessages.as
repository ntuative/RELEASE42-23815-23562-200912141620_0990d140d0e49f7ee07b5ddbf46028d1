package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_707);
         _loc2_.refreshViews();
         var_25.notifyChangedEffects();
      }
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_156)
            {
      ...
      public function onFurniList(param1:IMessageEvent) : void
      {
         ...
         while(_loc12_ < _loc3_.length)
         {
            ...
            if(_loc9_.indexOf(_loc6_.stripId) == -1)
            {
               ...
               {
                  _loc5_ = new FloorItem(_loc6_.stripId,_loc6_.classId,_loc6_.objId,_loc6_.category,_loc6_.method_5,_loc6_.isTradeable,_loc6_.isRecyclable,_loc6_.isSellable,_loc6_.stuffData,_loc6_.expiryTime,0,0,0,_loc6_.slotId,_loc6_.songId);
               }
               else
               {
                  ...
                  _loc5_ = new WallItem(_loc6_.stripId,_loc6_.classId,_loc6_.objId,_loc6_.category,_loc6_.method_5,_loc6_.isTradeable,_loc6_.isRecyclable,_loc6_.isSellable,_loc6_.stuffData);
               }
               if(_loc7_.length == 0)
               {
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_25.toggleInventorySubPage(InventorySubCategory.const_222);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_25.setInventoryCategoryInit(InventoryCategory.const_246);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_431);
         var _loc4_:FurniModel = var_25.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
