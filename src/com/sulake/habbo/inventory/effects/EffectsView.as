package com.sulake.habbo.inventory.effects
{
   ...
   public class EffectsView implements IInventoryView
   {
      ...
      private var var_546:ThumbListManager;
      
      private var var_545:ThumbListManager;
      ...
      public function EffectsView(param1:EffectsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IThumbListDataProvider, param6:IThumbListDataProvider)
      {
         ...
         var_545 = new ThumbListManager(_assetLibrary,param5,"thumb_bg_png","thumb_bg_selected_png",getActiveThumbListImageWidth(),getActiveThumbListImageHeight());
         var_546 = new ThumbListManager(_assetLibrary,param6,"thumb_bg_png","thumb_bg_selected_png",getActiveThumbListImageWidth(),getActiveThumbListImageHeight());
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               _loc3_ = var_88.getSelectedEffect(0);
               if(_loc3_ != null)
               {
                  var_88.requestEffectActivated(_loc3_.type);
               }
            }
         }
      }
      ...
      private function activeThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            _loc4_ = var_545.resolveIndexFromImageLocation(_loc3_);
            _loc5_ = var_88.getItemInIndex(_loc4_,1);
            if(_loc5_ != null)
            {
               var_88.toggleEffectSelected(_loc5_.type);
            }
         }
      }
      ...
      public function updateActionView() : void
      {
         ...
         var _loc3_:Effect = var_88.getSelectedEffect(-1);
         if(_loc3_ == null)
         {
            _loc1_.disable();
      ...
      public function updateListViews() : void
      {
         ...
         var _loc4_:BitmapData = var_545.getListImage();
      ...
      private function inactiveThumbListEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = new Point(WindowMouseEvent(param1).localX,WindowMouseEvent(param1).localY);
            _loc4_ = var_546.resolveIndexFromImageLocation(_loc3_);
            _loc5_ = var_88.getItemInIndex(_loc4_,0);
            if(_loc5_ != null)
            {
               var_88.toggleEffectSelected(_loc5_.type);
            }
