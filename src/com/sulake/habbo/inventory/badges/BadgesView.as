package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_957:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_957 = _view.findChildByName("inactive_items") as IItemGridWindow;
         var_957.procedure = inactiveGridEventProc;
         var_958 = _view.findChildByName("active_items") as IItemGridWindow;
         var_958.procedure = activeGridEventProc;
      }
      ...
      private function updateListViews() : void
      {
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               var_957.addGridItem(_loc2_.window);
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_957.getGridItemIndex(param1.window);
