package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboNavigator)
      {
         ...
         _loc2_.addHabboConnectionMessageEvent(new RoomSettingsDataEvent(method_9));
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         {
            case CantConnectMessageParser.const_1233:
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_154)
            {
               _navigator.doorbell.show(_loc2_.data);
            }
            else if(_loc2_.data.doorMode == RoomSettingsData.const_126)
            {
