package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1878 = new RoomThumbnailRenderer(param1);
         var_959 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_177,var_118.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         var_959.refreshTags(_loc1_,var_118.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1878.refreshThumbnail(_loc1_,var_118.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         refreshRoomName(var_177,var_118);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_177,!true ? getEventCtg(var_118.categoryId) : getRoomCtg(var_118.categoryId));
         refreshRoomDesc(var_177,var_118);
         refreshExtraCont();
         refreshInfo(var_177,"trading_allowed",var_118.allowTrading);
