package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_88:ThumbnailEditorModel;
      ...
      public function RoomThumbnailCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_88 = new ThumbnailEditorModel();
      }
      
      private function refreshTab() : void
      {
         setEnabled(_bgTabButton,this.var_88.mode != ThumbnailEditorModel.const_36);
         setEnabled(var_1389,this.var_88.mode != ThumbnailEditorModel.const_52);
         setEnabled(var_1388,this.var_88.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_88.mode = ThumbnailEditorModel.const_36;
         this.reload();
      }
      ...
      {
         this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(_window.findChildByName("picframe")),var_88.data,false);
      }
      ...
      public function set active(param1:Boolean) : void
      {
         ...
         if(_active)
         {
            var_88.data = _navigator.data.enteredGuestRoom.thumbnail.getCopy();
         }
      }
      ...
      private function onSaveButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in var_88.data.objects)
         {
            if(_loc4_.imgId > 0)
            {
               _loc3_.push(_loc4_);
         ...
         _loc5_ = new UpdateRoomThumbnailMessageComposer(_navigator.data.enteredGuestRoom.flatId,var_88.data.bgImgId,var_88.data.frontImgId,_loc3_.length);
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_88.mode = ThumbnailEditorModel.const_52;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1389 = IButtonWindow(find("top_tab"));
         var_1388 = IButtonWindow(find("obj_tab"));
         var_1806 = IWindowContainer(find("tile_grid"));
         var_1807 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1389,onTopTabButton);
         Util.setProcDirectly(var_1388,onObjTabButton);
      }
      ...
      private function refreshImgSelector(param1:int) : void
      {
         ...
         var _loc5_:int = var_88.getImgId();
         var _loc6_:int = 0;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1806;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_436)
            {
         ...
         _loc2_.visible = true;
         refreshTileLoc(_loc2_,var_88.selected.pos);
      ...
      private function onObjTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_88.mode = ThumbnailEditorModel.const_31;
         this.reload();
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Dictionary = var_88.getBlockedPositions();
         while(_loc3_ <= RoomThumbnailRenderer.const_436)
         {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_54,HabboWindowStyle.const_39,HabboWindowParam.const_64,new Rectangle(0,0,param1.width,66)));
