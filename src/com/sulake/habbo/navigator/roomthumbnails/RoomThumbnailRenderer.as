package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1091:int = -16;
      
      private static const const_764:int = 32;
      
      private static const const_1093:int = 8;
      
      public static const const_436:int = 10;
      ...
      private var var_853:ThumbnailImageConfigurations;
      ...
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         ...
         super();
         _navigator = param1;
         var_853 = new ThumbnailImageConfigurations(_navigator);
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_853.getImage(ThumbnailEditorModel.const_31,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1091,_loc4_.y + const_1092 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_2087[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_853.getImage(ThumbnailEditorModel.const_36,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_853.getImage(ThumbnailEditorModel.const_36,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_853.getImage(ThumbnailEditorModel.const_52,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_764 / 2);
         return new Point(param1 * const_764 + _loc3_,param2 * const_1093);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         var _loc4_:* = null;
         _loc3_ = 0;
         while(_loc3_ <= const_436)
         {
            var_1021[_loc3_] = null;
            _loc3_++;
         }
         for each(_loc4_ in param2)
         {
            var_1021[_loc4_.pos] = _loc4_;
         }
         _loc3_ = 0;
         while(_loc3_ <= const_436)
         {
            if(false)
            {
               refreshObj(param1,var_1021[_loc3_]);
            }
            _loc3_++;
         }
      }
