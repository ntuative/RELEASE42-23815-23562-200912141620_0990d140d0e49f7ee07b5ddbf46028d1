package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1488:CutToHeight = new CutToHeight();
      
      private static var var_1489:CutToWidth = new CutToWidth();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1488.beforeSearch(param2,param1,param3);
         binarySearch(var_1488,param2.length - 1);
      }
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1489.beforeSearch(param2,param1,param3);
         binarySearch(var_1489,param2.length - 1);
      }
   }
}
