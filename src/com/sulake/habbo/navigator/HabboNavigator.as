package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2278:Dictionary;
      ...
      private var var_1921:ISessionDataManager;
      
      private var var_1919:RoomCreateViewCtrl;
      ...
      private var var_1202:RoomInfoViewCtrl;
      
      private var var_70:IHabboCatalog;
      
      private var var_377:Tabs;
      
      private var var_462:MainViewCtrl;
      
      private var var_1920:Array;
      
      private var var_1009:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_462 = new MainViewCtrl(this);
         var_1202 = new RoomInfoViewCtrl(this);
         var_1919 = new RoomCreateViewCtrl(this);
         var_1878 = new RoomThumbnailRenderer(this);
         var_1009 = new GuestRoomPasswordInput(this);
         var_332 = new GuestRoomDoorbell(this);
         var_377 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_462.startSearch(Tabs.const_198,Tabs.const_278,param1);
         var_462.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_190.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_47,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_167.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_190 != null)
         {
            var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_190.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_128,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1921 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_462.startSearch(Tabs.const_259,Tabs.const_212);
         var_377.getTab(Tabs.const_259).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_462.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
