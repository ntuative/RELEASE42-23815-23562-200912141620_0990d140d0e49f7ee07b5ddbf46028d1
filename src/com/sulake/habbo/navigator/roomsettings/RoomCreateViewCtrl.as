package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_779:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1171 = new Timer(100);
         var_1171.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_66 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_967 = new TextFieldManager(_navigator,ITextFieldWindow(var_34.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_967.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1865 = _navigator.data.hcMember;
      }
      ...
      {
         var_967.goBackToInitialState();
         var_967.input.textBackgroundColor = 4294967295;
         var_779 = var_66[0];
         if(var_1865 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_54,HabboWindowStyle.const_39,HabboWindowParam.const_64,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_967.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_779.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!var_1172 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            var_1172 = true;
            _loc3_.y = 1;
