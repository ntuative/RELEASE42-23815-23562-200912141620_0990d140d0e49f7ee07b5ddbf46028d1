package com.sulake.habbo.navigator
{
   ...
   public class TextSearchInputs
   {
      ...
      public function TextSearchInputs(param1:HabboNavigator, param2:Boolean, param3:IWindowContainer)
      {
         ...
         _navigator = param1;
         var_2221 = param2;
         var_699 = new TextFieldManager(_navigator,ITextFieldWindow(param3.findChildByName("search_str")),25,searchRooms,_navigator.getText("navigator.search.info"));
      ...
      {
         var _loc1_:String = var_699.getText();
         if(_loc1_ == "")
         {
            return;
         }
