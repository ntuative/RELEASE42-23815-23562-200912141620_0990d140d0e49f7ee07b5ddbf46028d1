package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements ICoreUpdateReceiver
   {
      ...
      public static const const_559:int = 4;
      
      private static const const_478:int = 2;
      
      private static const const_733:int = 1;
      
      public static const const_1515:int = 3;
      
      private static const const_1004:int = 4;
      ...
      private var var_1075:IRegionWindow;
      
      private var var_362:int;
      
      private var var_1073:Boolean = true;
      
      private var var_1324:GuestRoomListCtrl;
      ...
      private var var_1325:OfficialRoomListCtrl;
      
      private var var_34:IWindowContainer;
      
      private var var_1326:PopularTagsListCtrl;
      ...
      public function MainViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1326 = new PopularTagsListCtrl(_navigator);
         var_1324 = new GuestRoomListCtrl(_navigator);
         var_1325 = new OfficialRoomListCtrl(_navigator);
      ...
      private function prepare() : void
      {
         ...
         var_232 = ITabContextWindow(var_28.findChildByName("tab_context"));
         var_34 = IWindowContainer(var_28.findChildByName("tab_content"));
         var_210 = IWindowContainer(var_28.findChildByName("custom_content"));
         var_188 = IWindowContainer(var_28.findChildByName("list_content"));
         var_245 = IWindowContainer(var_28.findChildByName("custom_footer"));
         var_11 = var_28.findChildByName("loading_text");
         var _loc1_:IWindow = var_28.findChildByTag("close");
         _loc1_.procedure = onWindowClose;
         var_1075 = IRegionWindow(var_28.findChildByName("to_hotel_view"));
         var_1075.procedure = onHotelView;
         ...
         var_28.scaler.setParamFlag(HabboWindowParam.const_1153,true);
      }
      ...
      {
         refreshScrollbar(var_1326);
         refreshScrollbar(var_1324);
         refreshScrollbar(var_1325);
      }
      ...
      {
         refreshList(param1,param2,var_1325,"official_rooms");
      }
      
      private function refreshPopularTags(param1:Boolean, param2:Boolean) : void
      {
         refreshList(param1,param2,var_1326,"popular_tags");
      }
      
      private function refreshGuestRooms(param1:Boolean, param2:Boolean) : void
      {
         refreshList(param1,param2,var_1324,"guest_rooms");
      }
      ...
      public function refresh() : void
      {
         ...
         var _loc1_:int = 0;
         Util.moveChildrenToColumn(var_34,["custom_content","list_content"],var_210.y,8);
         var_188.height = var_188.height + _loc1_ - 0 - 0 + var_1607;
         Util.moveChildrenToColumn(var_34,["list_content","custom_footer"],var_188.y,8);
         var_1607 = var_245.height;
         onResizeTimer(null);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_362 == const_733)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_188.blend - _loc2_));
            this.var_188.blend = _loc3_;
            this.var_210.blend = !!var_1073 ? Number(_loc3_) : Number(1);
            this.var_245.blend = !!var_1073 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               var_362 = const_478;
            }
         }
         else if(var_362 == const_478)
         {
            if(var_1072 % 10 == 1)
            {
               var_11.visible = true;
      ...
      {
         _navigator.refreshButton(var_1075,"icon_hotelview",!param1,null,0);
         _navigator.refreshButton(var_1075,"icon_hotelview_reactive",param1,null,0);
      }
