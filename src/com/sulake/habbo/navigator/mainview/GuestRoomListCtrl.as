package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         if(var_1168 != null)
         {
            _loc2_ = var_1168.tags[0];
            var_1168.color = getBgColor(_loc2_);
         }
         var_1168 = param1;
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(var_1847 - _loc2_.stageX);
         var_1847 = _loc2_.stageX;
         var_1846 = _loc3_ > 2;
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         _navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_154,null,0);
         ...
         var_1785.refreshUserCount(param2.maxUserCount,param1,param2.userCount,"${navigator.usercounttooltip.users}",233,2);
      }
            ...
            if(_loc7_.ownerName != _navigator.sessionData.userName)
            {
               ...
               switch(_loc7_.doorMode)
               {
                  case RoomSettingsFlatInfo.const_126:
                     ...
                     return;
                  case RoomSettingsFlatInfo.const_154:
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1124,true);
