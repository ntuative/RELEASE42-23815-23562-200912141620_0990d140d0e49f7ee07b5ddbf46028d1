package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_247,Tabs.const_305);
         }
         else if(_loc1_ == 1)
         {
            _navigator.mainViewCtrl.startSearch(Tabs.const_247,Tabs.const_639);
         }
         else
         {
            ...
            _navigator.mainViewCtrl.startSearch(Tabs.const_247,Tabs.const_305,"" + _loc3_);
         }
      }
