package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1449:TextSearchInputs;
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_198,Tabs.const_199,"-1",MainViewCtrl.const_721);
      }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(_navigator.data.guestRoomSearchResults.searchType == Tabs.const_278)
            {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1449 == null)
         {
            ...
            var_1449 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1449.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
