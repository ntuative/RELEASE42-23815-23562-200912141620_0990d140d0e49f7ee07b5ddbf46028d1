package com.hurlant.crypto.prng
{
   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         var_147 = new ByteArray();
         var_59 = 0;
         while(var_59 < psize)
         {
            _loc2_ = uint(65536 * Math.random());
            var _loc3_:* = var_59++;
            var_147[_loc3_] = _loc2_ >>> 8;
            var _loc4_:*;
            var_147[_loc4_ = var_59++] = _loc2_ & 255;
         }
         var_59 = 0;
         seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc2_:* = var_59++;
         var_147[_loc2_] = 0 ^ param1 & 255;
         var _loc3_:* = var_59++;
         var_147[_loc3_] = 0 ^ param1 >> 8 & 255;
         var _loc4_:*;
         var_147[_loc4_ = var_59++] = 0 ^ param1 >> 16 & 255;
         var _loc5_:*;
         var_147[_loc5_ = var_59++] = 0 ^ param1 >> 24 & 255;
         var_59 %= psize;
         var_2137 = true;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            var_147[_loc1_] = Math.random() * 256;
            _loc1_++;
         }
         var_147.length = 0;
         var_147 = null;
