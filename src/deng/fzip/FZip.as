package deng.fzip
{
   ...
   public class FZip extends EventDispatcher
   {
         ...
         if(param1.bytesAvailable >= 4)
         {
            ...
            switch(_loc2_)
            {
               case 67324752:
                  ...
                  var_456 = new FZipFile(charEncoding);
                  break;
               case 33639248:
               case 101010256:
                  parseFunc = parseIdle;
      ...
      {
         if(var_456.parse(param1))
         {
            var_54.push(var_456);
            if(false)
            {
               var_135["null"] = var_456;
            }
            dispatchEvent(new FZipEvent(FZipEvent.const_1158,var_456));
            var_456 = null;
      ...
      {
         var _loc2_:* = null;
         if(var_54 != null && var_135 != null && param1 < var_54.length)
         {
